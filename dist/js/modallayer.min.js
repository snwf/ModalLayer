...
n("Array.prototype.fill",function(e){return e?e:function(b,c,d){var f=this.length||0;0>c&&(c=Math.max(0,f+c));if(null==d||d>f)d=f;d=Number(d);0>d&&(d=Math.max(0,f+d));for(c=Number(c||0);c<d;c++)this[c]=b;return this}});function C(e){return e?e:Array.prototype.fill}n("Int8Array.prototype.fill",C);n("Uint8Array.prototype.fill",C);n("Uint8ClampedArray.prototype.fill",C);n("Int16Array.prototype.fill",C);n("Uint16Array.prototype.fill",C);n("Int32Array.prototype.fill",C);
n("Uint32Array.prototype.fill",C);n("Float32Array.prototype.fill",C);n("Float64Array.prototype.fill",C);n("String.prototype.startsWith",function(e){return e?e:function(b,c){var d=oa(this,b,"startsWith"),f=d.length,g=b.length;c=Math.max(0,Math.min(c|0,d.length));for(var h=0;h<g&&c<f;)if(d[c++]!=b[h++])return!1;return h>=g}});
...
function E(e,b,c){"undefined"!==typeof Reflect&&Reflect.get?E=Reflect.get:E=function(d,f,g){for(;!Object.prototype.hasOwnProperty.call(d,f)&&(d=F(d),null!==d););if(d)return f=Object.getOwnPropertyDescriptor(d,f),f.get?f.get.call(g):f.value};return E(e,b,c||e)}function G(e,b){if("function"!==typeof b&&null!==b)throw new TypeError("Super expression must either be null or a function");e.prototype=Object.create(b&&b.prototype,{constructor:{value:e,writable:!0,configurable:!0}});b&&qa(e,b)}
function H(e){var b=sa();return function(){var c=F(e);if(b){var d=F(this).constructor;c=Reflect.construct(c,arguments,d)}else c=c.apply(this,arguments);if(!c||"object"!==pa(c)&&"function"!==typeof c){if(void 0===this)throw new ReferenceError("this hasn't been initialised - super() hasn't been called");c=this}return c}}function F(e){F=Object.setPrototypeOf?Object.getPrototypeOf:function(b){return b.__proto__||Object.getPrototypeOf(b)};return F(e)}
function ta(e,b,c){sa()?ta=Reflect.construct:ta=function(d,f,g){var h=[null];h.push.apply(h,f);d=new (Function.bind.apply(d,h));g&&qa(d,g.prototype);return d};return ta.apply(null,arguments)}function sa(){if("undefined"===typeof Reflect||!Reflect.construct||Reflect.construct.a)return!1;if("function"===typeof Proxy)return!0;try{return Reflect.construct(Date,[],function(){}),!0}catch(e){return!1}}function qa(e,b){qa=Object.setPrototypeOf||function(c,d){c.__proto__=d;return c};return qa(e,b)}
function ua(e){var b=Array.isArray(e)?e:void 0;if(!b)if("undefined"!==typeof Symbol&&Symbol.iterator in Object(e)){b=[];var c=!0,d=!1,f=void 0;try{for(var g=e[Symbol.iterator](),h;!(c=(h=g.next()).done)&&(b.push(h.value),2!==b.length);c=!0);}catch(k){d=!0,f=k}finally{try{if(!c&&null!=g["return"])g["return"]()}finally{if(d)throw f;}}}else b=void 0;if(!(e=b||va(e,2)))throw new TypeError("Invalid attempt to destructure non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method.");
return e}function I(e){var b=Array.isArray(e)?wa(e):void 0;b||(b="undefined"!==typeof Symbol&&Symbol.iterator in Object(e)?Array.from(e):void 0);if(!(e=b||va(e)))throw new TypeError("Invalid attempt to spread non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method.");return e}
function va(e,b){if(e){if("string"===typeof e)return wa(e,b);var c=Object.prototype.toString.call(e).slice(8,-1);"Object"===c&&e.constructor&&(c=e.constructor.name);if("Map"===c||"Set"===c)return Array.from(e);if("Arguments"===c||/^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(c))return wa(e,b)}}function wa(e,b){if(null==b||b>e.length)b=e.length;for(var c=0,d=Array(b);c<b;c++)d[c]=e[c];return d}function J(e,b){if(!(e instanceof b))throw new TypeError("Cannot call a class as a function");}
function xa(e,b){for(var c=0;c<b.length;c++){var d=b[c];d.enumerable=d.enumerable||!1;d.configurable=!0;"value"in d&&(d.writable=!0);Object.defineProperty(e,d.key,d)}}function O(e,b,c){b&&xa(e.prototype,b);c&&xa(e,c)}function P(e,b,c){b in e?Object.defineProperty(e,b,{value:c,enumerable:!0,configurable:!0,writable:!0}):e[b]=c}var Q=Object.create(null);Q.browser=Object.create(null);Q.feature=Object.create(null);
...
Object.defineProperty(R,"drag",{enumerable:!0,value:function(e){function b(q){var v;var w=[];q=null!==(v=q)&&void 0!==v?v:window.event;switch(q.code){case "ArrowUp":w[1]=-1;break;case "ArrowDown":w[1]=1;break;case "ArrowLeft":w[0]=-1;break;case "ArrowRight":w[0]=1;break;default:return}q.preventDefault();d(w[0],w[1])}function c(q){var v;q=h=null!==(v=q)&&void 0!==v?v:window.event;d(q.movementX,q.movementY)}function d(q,v){1!==h.buttons?t():(g.option.drag.overflow||(m.x+q<p[0]&&(m.x=p[0]-q),m.right+
q>p[1]&&(m.x=p[1]-m.width-q),m.y+v<p[2]&&(m.y=p[2]-v),m.bottom+v>p[3]&&(m.y=p[3]-m.height-v)),m.x+=q,m.y+=v,g.option.resize.enable&&g.option.content.fullContainer&&(q=[5,p[1]-m.width-5],v=[5,p[3]-m.height-5],m.x<=q[0]?m.x=q[0]:m.x>=q[1]&&(m.x=q[1]),m.y<=v[0]?m.y=v[0]:m.y>=v[1]&&(m.y=v[1])),l.style.marginLeft=m.x+"px",l.style.marginTop=m.y+"px",g.setStatus("drag"))}var f,g=this,h;var k=this.status;e=null!==(f=e)&&void 0!==f?f:window.event;var l=this.variable.nodes.container;var m=l.getBoundingClientRect();
e=window.document.documentElement.getBoundingClientRect();var p=[e.x,e.x+e.width,e.x,e.y+e.height];window.getSelection().empty();var t=function v(){document.removeEventListener("keyup",b,!0);document.removeEventListener("mousemove",c);document.removeEventListener("mouseup",v);g.setStatus(k)};document.addEventListener("mouseup",t);document.addEventListener("mousemove",c);document.addEventListener("keyup",b,!0)}});
Object.defineProperty(R,"resize",{enumerable:!0,value:function(e){function b(q){var v;if(1!==q.buttons)t();else{d.setStatus("resize");q=null!==(v=q)&&void 0!==v?v:window.event;v=q.screenX-l[0];var w=q.screenY-l[1];q=g.getAttribute("position-resize-bar");var r=[h.x,h.y,m[0],m[1]];q.includes("top")&&(r[1]+=w,r[3]-=w,r[1]<p.y&&(r[3]-=p.y-r[1]),r[3]<k[1]&&(r[1]+=r[3]-k[1],r[3]=k[1]));q.includes("bottom")&&(r[3]+=w,r[3]<k[1]&&(r[3]=k[1]));q.includes("left")&&(r[0]+=v,r[2]-=v,r[0]<p.x&&(r[2]-=p.x-r[0]),
r[2]<k[0]&&(r[0]+=r[2]-k[0],r[2]=k[0]));q.includes("right")&&(r[2]+=v,r[2]<k[0]&&(r[2]=k[0]));d.resizeByXYWH(Number(r[0]),Number(r[1]),Number(r[2]),Number(r[3]))}}var c,d=this;var f=this.status;e=null!==(c=e)&&void 0!==c?c:window.event;var g=e.target;var h=this.variable.nodes.container.getBoundingClientRect();var k=this.variable.defaultArea;var l=[e.screenX,e.screenY];var m=[h.width,h.height];var p=document.documentElement.getBoundingClientRect();window.getSelection().empty();var t=function v(){document.removeEventListener("mousemove",
b);document.removeEventListener("mouseup",v);d.setStatus(f)};document.addEventListener("mouseup",t);document.addEventListener("mousemove",b)}});Object.defineProperty(R,"minimizeRevert",{enumerable:!0,value:function(){if("1"!=this.getAttribute("clicked")){this.setAttribute("clicked",1);var e=Number(this.getAttribute("modal-layer-index"));delete S._minimizeQueue[S._minimizeQueue.indexOf(S._instance[e])]}}});
...
var S=function(){function e(b,c){J(this,e);P(this,"type",null);P(this,"status",null);P(this,"event",null);P(this,"option",null);P(this,"variable",{});try{var d,f,g,h,k,l;null===(d=b.hook)||void 0===d?void 0:null===(f=d.initStart)||void 0===f?void 0:null===(g=f.call)||void 0===g?void 0:g.call(f,b);this.type=b.type;this.status=e._enum.STATUS.HIDE;this.compatibleOption(b);this.initOption(b);this.checkOption();this.linkageOption();this.initVariable();this.initStruct();this.initNode();this.initNodeFinally();
this.initEvent();this.bindEvent();null===(h=this.option.hook)||void 0===h?void 0:null===(k=h.initEnded)||void 0===k?void 0:null===(l=k.call)||void 0===l?void 0:l.call(k,this);this.insertNode()}catch(m){null===c||void 0===c?void 0:c.call(null,m)}}O(e,[{key:"initOption",value:function(b){var c;b.index=e._instance.length;b.window=null!==(c=b.window)&&void 0!==c?c:window.document.body;this.option=e._assistant.object.merge(b,e._option.common)}},{key:"compatibleOption",value:function(b){var c,d;if("boolean"===
...
e._enum.TYPE.LOADING;b=new (e._achieve.get("loading"))(b,c);b.resize();b.show();return b}}]);return e}();P(S,"_env",Q);P(S,"_enum",V);P(S,"_struct",U);P(S,"_option",T);P(S,"_variable",new Map);P(S,"_worker",window.Worker?new Map:void 0);P(S,"_event",R);P(S,"_version",1);P(S,"_achieve",new Map);P(S,"_assistant",Object.create(null));P(S,"_instance",new Proxy([],{set:function(e,b,c){if(c instanceof S||"length"===b)return e[b]=c,!0;throw new TypeError("Must be of type ModalLayer");}}));
P(S,"_minimizeQueue",new Proxy([],{set:function(e,b,c){if(c instanceof S){var d=e.indexOf(c);c.minimize();0>d?e[b]=c:e[d]=c;return!0}return"length"===b?(e[b]=c,!0):!1},deleteProperty:function(e,b){b=parseInt(b);if(Number.isInteger(b)&&e[b]instanceof S){e[b].revert();if(e[b+1])for(;b<e.length-1;b++)e[b]=e[b+1];delete e[e.length-1];e.length--;return!0}}}));Object.seal(S);
...
Event?h[h.length-1]=z:h.push(z);(t?r:f).apply(g===d?u:g,h);break}}}p.set(q,{type:c,element:b,options:k,selector:d,callback:x,wantsUntrusted:m});b.addEventListener(c,x,k,m)}):new Promise(function(r){var x;f=(x=t?r:f).bind.apply(x,[g].concat(I(h)));p.set(q,{type:c,element:b,options:k,selector:d,callback:f,wantsUntrusted:m});b.addEventListener(c,f,k,m)});return t?l:q}},{key:"remove",value:function(b){var c;var d=Y.get("cache",e);if(c=null===d||void 0===d?void 0:d.get(b))c.element.removeEventListener(c.type,
...
c||void 0===c?void 0:c(g);d(g)}})}},{key:"addListener",value:function(b){var c=1<arguments.length&&void 0!==arguments[1]?arguments[1]:void 0;if(!(b instanceof Worker)&&(b=e.get(b),void 0===b))throw Error("Worker not found.");return new Promise(function(d,f){b.addEventListener("messageerror",f);b.addEventListener("message",function(g){null===c||void 0===c?void 0:c(g);d(g)})})}}]);return e}();Object.defineProperty(S._assistant,"worker",{value:Ca});
var X=function(){function e(){J(this,e)}O(e,null,[{key:"dereference",value:function(b){Object.keys(b).forEach(function(c){var d=b[c];if(e.isCollection(d))if(e.dereference(d),d instanceof Map)b["delete"](c);else if(d instanceof Set)b["delete"](d);else b[c]=null;else b[c]=null})}},{key:"get",value:function(b,c){c=Array.isArray(c)?c:c.split(".");for(var d=0;d<c.length&&!e.isEmpty(b);d++)b=b[c[d]];return b}},{key:"set",value:function(b,c,d){c=Array.isArray(c)?c:c.split(".");for(var f=0;f<c.length;b=b[c[f]],
...
var Da=function(){function e(){J(this,e)}O(e,null,[{key:"mul",value:function(b,c){var d,f;b=[b.toString().split("."),c.toString().split(".")];c=Math.pow(10,Math.max(null!==(d=b[0][1].length)&&void 0!==d?d:0,null!==(f=b[1][1].length)&&void 0!==f?f:0));b=[[Number(b[0][0]),Number("0."+b[0][1])*c],[Number(b[1][0]),Number("0."+b[1][1])*c]];return(0!==b[0][0]?b[0][0]:1)*(0!==b[1][0]?b[1][0]:1)+b[0][1]*b[1][1]/c}},{key:"div",value:function(b,c){var d,f,g,h;var k=Math.pow(10,Math.max(null!==(d=null===(f=
...
(new Function('"use strict"; return '+(b+d[f]+c[0]+"&&"+b+d[g]+c[1])))():!1}},{key:"insideRect",value:function(b,c){var d=c[0];c=c[1];return b[0]<d[0]||b[1]<d[1]||b[0]>c[0]||b[1]>c[1]?!1:!0}}]);return e}();window.math&&(Da.__proto__=window.math);Object.defineProperty(S._assistant,"number",{value:Da});
var Ea=function(){function e(){J(this,e)}O(e,null,[{key:"base64Encode",value:function(b){return window.btoa(window.unescape(window.encodeURIComponent(b)))}},{key:"base64Decode",value:function(b){return window.decodeURIComponent(window.escape(window.atob(b)))}},{key:"ucfirst",value:function(b){return b[0].toUpperCase()+b.substring(1)}},{key:"replace",value:function(b,c,d){var f,g,h,k,l,m=3<arguments.length&&void 0!==arguments[3]?arguments[3]:0,p,t;c=Array.isArray(c)?c:[c];d=Array.isArray(d)?d:[d];
...
Object.defineProperty(S._assistant,"element",{value:Fa});
var Ga=function(){function e(){J(this,e)}O(e,null,[{key:"getDistribution",value:function(b,c){var d=2<arguments.length&&void 0!==arguments[2]?arguments[2]:2,f,g;if(1===d&&Array.isArray(b))throw Error("One-dimensional operation position value cannot be an array");if(2===d&&!Array.isArray(b))throw Error("Two-dimensional operation position value must be an array");(g=Y.get("gaussian",e))||(g=new Map,Y.set("gaussian",g,e));(f=g.get(c))||(f=Object.create(null),f.square=c*c,f.multiplier=[1/(c*Math.sqrt(2*
...
var Z=function(){function e(){J(this,e)}O(e,null,[{key:"getStorage",value:function(b){var c=1<arguments.length&&void 0!==arguments[1]?arguments[1]:[];if(!e._achieve[b])throw Error("The specified storage ".concat(b," was not found."));return ta(e._achieve[b],I(c))}}]);return e}();P(Z,"_achieve",Object.create(null));Object.defineProperty(S._assistant,"storage",{value:Z});
var Ha=function(){function e(){J(this,e)}O(e,null,[{key:"drawText",value:function(b,c){c=X.o(c,{text:null,fill:!0,color:"black",direction:"ltr",textAlign:"center",textBaseline:"middle",font:"normal 16px Microsoft YaHei, serif",point:[b.canvas.width/2,b.canvas.height/2]});c.text&&(b.save(),b.font=c.font,b.fillStyle=c.color,b.direction=c.direction,b.textAlign=c.textAlign,b.textBaseline=c.textBaseline,c.point[1]+=b.measureText(c.text).G/2,!0===c.fill?b.fillText.apply(b,[c.text].concat(I(c.point),[c.maxWidth])):
b.strokeText.apply(b,[c.text].concat(I(c.point),[c.maxWidth])),b.restore())}},{key:"drawRound",value:function(b,c){c=X.o(c,{step:[],radius:5,fill:!0,borderWidth:5,borderColor:"black",fillColor:"transparent",point:[b.canvas.width/2,b.canvas.height/2]});b.save();b.fillStyle=c.fillColor;b.lineWidth=c.borderWidth;b.strokeStyle=c.borderColor;b.beginPath();b.setLineDash(c.step);b.arc.apply(b,I(c.point).concat([c.radius,0,2*Math.PI]));b.stroke();!0===c.fill&&b.fill();b.restore()}},{key:"drawRect",value:function(b){var c=
...
1<arguments.length&&void 0!==arguments[1]?arguments[1]:0,d=2<arguments.length&&void 0!==arguments[2]?arguments[2]:0,f=3<arguments.length?arguments[3]:void 0,g=4<arguments.length?arguments[4]:void 0,h=5<arguments.length&&void 0!==arguments[5]?arguments[5]:1,k=6<arguments.length&&void 0!==arguments[6]?arguments[6]:"black",l=7<arguments.length&&void 0!==arguments[7]?arguments[7]:!1;var m=[Da.divide(f,4),Da.divide(g,4)];b.save();b.beginPath();b.lineWidth=h;b.strokeStyle=k;Array.isArray(l)&&b.setLineDash(l);
for(h=1;4>h;h++)b.moveTo(m[0]*h+c,d),b.lineTo(m[0]*h+c,d+g),b.moveTo(c,m[1]*h+d),b.lineTo(c+f,m[1]*h+d);b.stroke();b.restore()}},{key:"layerMerge",value:function(b,c,d,f,g){var h=5<arguments.length&&void 0!==arguments[5]?arguments[5]:"source-over",k;(k=Y.get("mergeCas",e))||(k=new OffscreenCanvas(b.canvas.width,b.canvas.height),Y.set("mergeCas",k,e));var l=k.getContext("2d");l.save();l.drawImage.apply(l,[c].concat(I(d)));l.globalCompositeOperation=h;l.drawImage.apply(l,[f].concat(I(g)));b.clearRect(0,
0,b.canvas.width,b.canvas.height);b.drawImage(k,0,0);l.restore();l.clearRect(0,0,k.width,k.height)}},{key:"download",value:function(b){var c=1<arguments.length&&void 0!==arguments[1]?arguments[1]:"canvas",d=2<arguments.length?arguments[2]:void 0;if(Y.has("downloadNode",e))var f=Y.get("downloadNode",e);else f=document.createElement("a"),Y.set("downloadNode",f,e);f.download=c;f.href=b.toDataURL(d);f.click()}}]);return e}();Object.defineProperty(S._assistant,"canvas",{value:Ha});
var Ia=function(){function e(){J(this,e)}O(e,null,[{key:"getImagedata",value:function(b){if(b instanceof Image){var c=document.createElement("canvas");var d=c.getContext("2d");d.drawImage(b,0,0);b=d.getImageData(0,0,c.width,c.height)}else if(!(b instanceof ImageData))throw Error("can not parse image");return b}},{key:"grayscale",value:function(b){try{var c=e.getImagedata(b);var d=c.width*c.height*4;var f=new Uint8ClampedArray(c.data.length);for(b=0;b<d;b+=4){var g=c.data[b];var h=c.data[b+1];var k=
...
l[m]=g.data[p];l[m+1]=g.data[p+1];l[m+2]=g.data[p+2];l[m+3]=g.data[p+3];l[p]=g.data[m];l[p+1]=g.data[m+1];l[p+2]=g.data[m+2];l[p+3]=g.data[m+3]}}catch(t){throw t;}return new ImageData(l,h,k)}}]);return e}();P(Ia,"__gaussianMask",{});Object.defineProperty(S._assistant,"canvasFilter",{value:Ia});
var Ja=function(){function e(){J(this,e)}O(e,null,[{key:"loadFailedFade",value:function(b,c){var d,f,g,h;if(!(b instanceof CanvasRenderingContext2D))throw Error('Requires a value of type "CanvasRenderingContext2D"');X.isEmpty(c)&&(c=Object.create(null));var k="animation-loadFailedFade-"+Date.now()+"-"+performance.now()+(c.sign?"-"+c.sign:"");c=X.o(c,{duration:4,speed:null,icon:{size:72,"char":["!","?"],color:"rgba(220, 53, 69)",font:"bold 72px Microsoft YaHei, serif"},text:{size:16,color:"black",
...
g[t].getContext("2d");c.icon.text=c.icon["char"][t];Ha.drawText(q,c.icon)}d.set(l,g)}(h=d.get(m))||(h=new OffscreenCanvas(c.text.size*c.text.text.length,2*c.text.size),l=h.getContext("2d"),Ha.drawText(l,c.text),d.set(m,h));(m=d.get(p))||(m=l=2*(c.round.radius+c.round.borderWidth),m=new OffscreenCanvas(m,l),l=m.getContext("2d"),Ha.drawRound(l,c.round),d.set(p,m));var v=1;var w=f=0;var r=[b.canvas.width/2,b.canvas.height/2];d=[m.width/2,(m.height+h.height)/2];p=[h.width/2,(m.height-h.height)/2];var x=
...
return k}}]);return e}();Object.defineProperty(S._assistant,"canvasAnimation",{value:Ja});
var Ka=function(e){function b(){J(this,b);return c.apply(this,arguments)}G(b,e);var c=H(b);O(b,[{key:"initOption",value:function(d){E(F(b.prototype),"initOption",this).call(this,d);this.option.layer=S._assistant.object.merge(this.option.layer,S._option.page)}},{key:"linkageOption",value:function(){E(F(b.prototype),"linkageOption",this).call(this);null!==this.option.layer.src&&null!==this.option.layer.srcdoc&&(this.option.layer.srcdoc=null)}},{key:"initStruct",value:function(){E(F(b.prototype),"initStruct",
...
null).position?d:Math.max(S._assistant.element.getNodeHeight(g[k]),d);f.style.width=h+"px";f.style.height=d+"px";this.variable.defaultArea=[h,d]}}]);return b}(S);S._achieve.set("page",Ka);
var La=function(e){function b(){J(this,b);return c.apply(this,arguments)}G(b,e);var c=H(b);O(b,[{key:"initStruct",value:function(){E(F(b.prototype),"initStruct",this).call(this);var d=this.variable.struct._build.container;var f=this.variable.struct._backup.title=S._struct.title;var g=this.variable.struct._backup.action=S._struct.action;var h=this.variable.struct._backup.content=S._struct.content;var k=this.variable.struct._backup.interaction=S._struct.interaction;var l=this.variable.struct._backup.action_button=
...
value:function(){E(F(b.prototype),"initNode",this).call(this);var d=this.variable.nodes.container.querySelector(".modal-layer-content");if(Array.isArray(this.option.content.value)){var f=S._assistant.element.objectToNode(this.option.content.value);Object.keys(f).forEach(function(g){d.appendChild(f[g])})}else d.innerHTML=this.option.content.value}}]);return b}(S);S._achieve.set("alert",La);
var Na=function(e){function b(){J(this,b);return c.apply(this,arguments)}G(b,e);var c=H(b);O(b,[{key:"initOption",value:function(d){var f=this,g;E(F(b.prototype),"initOption",this).call(this,d);this.option.layer=S._assistant.object.merge(this.option.layer,S._option.image);var h=[window.innerWidth,window.innerHeight];Object.values(this.option.layer.sizeRange).forEach(function(k){k.forEach(function(l,m){if((""+l).endsWith("%"))g=100;else if((""+l).endsWith("\u2030"))g=1E3;else if((""+l).includes("0."))g=
...
var g=f.querySelector(".modal-layer-content");var h=g.querySelector(".modal-layer-image-canvas").getBoundingClientRect();var k=f.querySelector(".modal-layer-toolbar");var l=k.getBoundingClientRect().height;var m=window.getComputedStyle(g,null);var p=S._assistant.element.getBeforeElementHeight(g);g=g.offsetTop-p;p+=this.option.content.fullContainer?0:2*g;this.option.layer.size?d=I(this.option.layer.size):this.variable.image.status!==S._enum.LOAD_STATUS.LOADING?d=[h.width,h.height]:d=I(this.option.layer.sizeRange.min);
...
S._enum.LOAD_STATUS.LOADING;f.setAttribute("load-status",S._assistant.object.getKeyByValue(S._enum.LOAD_STATUS,S._enum.LOAD_STATUS.LOADING));this.variable.image.fadeAttr&&f.removeAttribute(this.variable.image.fadeAttr);this.variable.image.layer instanceof Ma?this.variable.image.layer.show():this.variable.image.layer=S.loading({mask:!1,popupTime:0,layer:{icon:1,duration:1,color:"deepskyblue"},window:this.variable.nodes.container},function(g){throw g;});return this.variable.image.finish=new Promise(function(g,
...
d.naturalHeight<this.option.layer.sizeRange.min[1]?S._assistant.number.getMinLegalSize([d.naturalWidth,d.naturalHeight],this.option.layer.sizeRange.min):[d.naturalWidth,d.naturalHeight];g.width=this.variable.image["default"].size[0];g.height=this.variable.image["default"].size[1];g.setAttribute("load-status",S._assistant.object.getKeyByValue(S._enum.LOAD_STATUS,S._enum.LOAD_STATUS.LOADED));window.requestAnimationFrame(function(){var h,k;f.variable.image.layer&&f.variable.image.layer instanceof Ma&&
f.variable.image.layer.hide();(h=g.getContext("2d")).drawImage.apply(h,[d,0,0,d.width,d.height,0,0].concat(I(f.variable.image["default"].size)));f.variable.image["default"].imageData=(k=g.getContext("2d")).getImageData.apply(k,[0,0].concat(I(f.variable.image["default"].size)))})}},{key:"failed",value:function(){var d,f;var g=this.variable.nodes.container.querySelector(".modal-layer-image-canvas");this.variable.image.status=S._enum.LOAD_STATUS.FAILED;g.setAttribute("load-status",S._assistant.object.getKeyByValue(S._enum.LOAD_STATUS,
...
this.option.title,"image/png")}}]);return b}(S);S._achieve.set("image",Na);var Oa=function(e){function b(){J(this,b);return c.apply(this,arguments)}G(b,e);var c=H(b);O(b,[{key:"initStruct",value:function(){E(F(b.prototype),"initStruct",this).call(this);this.variable.struct._backup.interaction.innerHTML.push(this.variable.struct._backup.interaction_button.cancel)}}]);return b}(La);S._achieve.set("prompt",Oa);
var Pa=function(e){function b(){J(this,b);return c.apply(this,arguments)}G(b,e);var c=H(b);O(b,[{key:"initStruct",value:function(){E(F(b.prototype),"initStruct",this).call(this);this.variable.struct._backup.interaction.innerHTML.push(this.variable.struct._backup.interaction_button.no)}}]);return b}(La);S._achieve.set("confirm",Pa);
var Ma=function(e){function b(){J(this,b);return c.apply(this,arguments)}G(b,e);var c=H(b);O(b,[{key:"initOption",value:function(d){E(F(b.prototype),"initOption",this).call(this,d);this.option.layer=S._assistant.object.merge(this.option.layer,S._option.loading);this.option.title=!1;this.option.drag.enable=!1;this.option.resize.enable=!1;this.option.progress.enable=!1}},{key:"compatibleOption",value:function(d){var f={center:"center",right:"flex-end",left:"flex-start"};E(F(b.prototype),"compatibleOption",
...
this.option.content.value}}]);return b}(S);S._achieve.set("msg",Qa);S._achieve.set("message",Qa);window.Worker&&S._worker.set("canvasFilter",function(){this.onmessage=function(e){var b,c;e=null===(b=(c=e.data).type)||void 0===b?void 0:b.call(c,e.data);this.postMessage({error:0,buffer:e?e.buffer:void 0},[e.buffer])};this.C=function(){this.postMessage({error:1,message:"Failed to send message."})}});
var Ra=function(e){function b(){var d=0<arguments.length&&void 0!==arguments[0]?arguments[0]:S._enum.BROWSER_STORAGE.SESSIONSTORAGE;J(this,b);if(!window[d])throw Error("The current browser does not support ".concat(d," function"));var f=c.call(this);f._record=[];f._type=d;f._storage=window[d];return f}G(b,e);var c=H(b);O(b,[{key:"has",value:function(d){return null!==this._storage.getItem(d)?!0:!1}},{key:"get",value:function(d){var f;return null!==(f=this._storage.getItem(d))&&void 0!==f?f:!1}},{key:"set",
value:function(d){this._storage.setItem(d,1<arguments.length&&void 0!==arguments[1]?arguments[1]:"");this._record.push(d);return!0}},{key:"del",value:function(d){var f=this._record.indexOf(d);if(!(1<arguments.length&&void 0!==arguments[1]&&arguments[1])&&0>f)return!1;0<=f&&this._record.splice(f,1);this._storage.removeItem(d);return!0}},{key:"clear",value:function(){for(;0<this._record.length;)this._storage.removeItem(this._record.shift());return!0}}]);return b}(function(){function e(){J(this,e);P(this,
"_type",null);P(this,"_record",null);P(this,"_storage",null)}O(e,[{key:"has",value:function(){}},{key:"get",value:function(){}},{key:"set",value:function(){}},{key:"del",value:function(){}},{key:"clear",value:function(){}}]);return e}());Z&&(Object.defineProperty(Z._achieve,S._enum.BROWSER_STORAGE.LOCALSTORAGE,{value:Ra}),Object.defineProperty(Z._achieve,S._enum.BROWSER_STORAGE.SESSIONSTORAGE,{value:Ra}));}(window);
