...
var T=function(){function d(a,b){K(this,d);P(this,"type",null);P(this,"status",null);P(this,"event",null);P(this,"option",null);P(this,"variable",{});try{var c,e,f,g,k,h;null===(c=a.hook)||void 0===c?void 0:null===(e=c.initStart)||void 0===e?void 0:null===(f=e.call)||void 0===f?void 0:f.call(e,a);this.type=a.type;this.status=d._enum.STATUS.HIDE;this.compatibleOption(a);this.initOption(a);this.checkOption();this.linkageOption();this.initVariable();this.initStruct();this.initNode();this.initNodeFinally();
this.initAnimation();this.initEvent();this.bindEvent();null===(g=this.option.hook)||void 0===g?void 0:null===(k=g.initEnded)||void 0===k?void 0:null===(h=k.call)||void 0===h?void 0:h.call(k,this);this.insertNode()}catch(l){d._instance.splice(d._instance.indexOf(this),1),null===b||void 0===b?void 0:b.call(null,l)}}O(d,[{key:"initOption",value:function(a){a.index=d._instance.length;d._instance[a.index]=this;this.option=d._assistant.object.merge(a,d._option.common)}},{key:"compatibleOption",value:function(a){var b,
c;d._assistant.object.isString(a.window)&&(a.window=document.querySelector(a.window));a.position&&(Array.isArray(a.position)||(a.position=Number.isInteger(a.position)?[a.position,a.position]:null));if("boolean"===typeof a.mask||["true","false"].includes(a.mask))a.mask={enable:!!a.mask,clickRemove:!0};d._assistant.object.isOnlyObject(a.content)||(a.content={value:a.content,fullContainer:null!==(b=null===(c=a.content)||void 0===c?void 0:c.fullContainer)&&void 0!==b?b:!1})}},{key:"linkageOption",value:function(){0>=
this.option.popupTime&&(this.option.progress.enable=!1);!1===this.option.title&&(this.option.drag.enable=!1)}},{key:"checkOption",value:function(){if(Number.isFinite(this.option.transition.animation)){if(!Object.values(d._enum.TRANSITION_ANIMATION_PRESET).includes(this.option.transition.animation))throw Error("No preset animation found.");}else if(null!==this.option.transition.animation&&!(Array.isArray(this.option.transition.animation)||this.option.transition.animation instanceof Animation))throw Error("Expects a css animation name or Animation object.");
}},{key:"initVariable",value:function(){this.variable.struct=Object.create(null);this.variable.timeout=Object.create(null);this.variable.interval=Object.create(null);this.variable.animation=Object.create(null);this.variable.eventSymbol=Object.create(null);this.variable.defaultRect=Object.create(null);this.variable.struct._build=Object.create(null);this.variable.struct._backup=Object.create(null)}},{key:"initStruct",value:function(){var a;if(null===(a=this.option.mask)||void 0===a?0:a.enable)this.variable.struct._build.mask=
d._struct.mask;this.variable.struct._build.container=d._struct.container}},{key:"initNode",value:function(){this.variable.nodes=d._assistant.element.objectToNode(this.variable.struct._build);var a=this.variable.nodes.mask;var b=this.variable.nodes.container;var c=b.querySelector(".modal-layer-interaction-btn-ok");var e=b.querySelector(".modal-layer-interaction-btn-no");var f=b.querySelector(".modal-layer-interaction-btn-cancel");null!==this.option.window&&(null===a||void 0===a?void 0:a.setAttribute("has-window",
""),b.setAttribute("has-window",""));b.setAttribute("modal-layer-popup-time",this.option.popupTime);b.setAttribute("content-full-container",Number(this.option.content.fullContainer));b.setAttribute("modal-layer-type",d._assistant.object.getKeyByValue(d._enum.TYPE,this.type).toLowerCase());b.setAttribute("allow-drag",Number(this.option.drag.enable));b.setAttribute("allow-resize",Number(this.option.resize.enable));if(this.option.progress.enable){a=["top","left","right","bottom"];var g=b.querySelector(".modal-layer-progress-bar");
a.includes(this.option.progress.position)||(this.option.progress.position=a[3]);g.setAttribute("progress-bar-position",this.option.progress.position);g.querySelector(".modal-layer-progress-bar-progress").style.cssText+="background: "+this.option.progress.color;g.querySelector(".modal-layer-progress-bar-background").style.cssText+="background: "+this.option.progress.background}if(!1!==this.option.title){var k=b.querySelector(".modal-layer-title-content");if(this.option.title instanceof Object){var h=
d._assistant.element.objectToNode(this.option.title);Object.keys(h).forEach(function(l){k.appendChild(h[l])})}else k.innerHTML=this.option.title}c&&(c.innerText=this.option.text.interaction.ok);e&&(e.innerText=this.option.text.interaction.no);f&&(f.innerText=this.option.text.interaction.cancel)}},{key:"initNodeFinally",value:function(){var a=this.option.ui;var b="modal-layer-skin-"+this.option.skin;var c="modal-layer-index-"+this.option.index;Object.keys(this.variable.nodes).forEach(function(e){for(var f=
d._assistant.element.getAllElement(this.variable.nodes[e]),g=0;g<f.length;g++)f[g].classList.contains(a)&&f[g].classList.remove(a),f[g].className="".concat(a," ").concat(f[g].className);this.variable.nodes[e].className=a+" "+b+" "+c+" "+this.variable.nodes[e].className.trim()+" modal-layer-hide"},this)}},{key:"initAnimation",value:function(){var a=this;var b=Object.create(null);var c=this.variable.nodes;if(null!==this.option.transition.animation){var e=this.option.transition.animation;b.D=[{opacity:0},
{opacity:1}];b.container=[[{opacity:0,transform:"scale(.45)"},{opacity:1,transform:"scale(1)"}],[{opacity:0,transform:"translateY(-100%)"},{opacity:1,transform:"translateY(0)"}],[{opacity:0,transform:"rotateY(-120deg)"},{opacity:1,transform:"rotateY(0)"}],[{opacity:0,transform:"skewX(-100deg)"},{opacity:1,transform:"skewX(0deg)"}],[{opacity:0,transform:"translateY(200%) scale(.45)"},{opacity:1,transform:"translateY(0) scale(1)"}]];var f={fill:"both",id:"modal-layer-transition-animation",easing:this.option.transition.easing,
duration:1E3*this.option.transition.duration};this.variable.animation.transition=Object.create(null);Object.keys(c).forEach(function(g){"container"===g?(e instanceof Animation?e.effect.target=c[g]:(e=Array.isArray(e)?e:b[g][e],e=c[g].animate(e,f)),a.variable.animation.transition[g]=e):a.variable.animation.transition[g]=c[g].animate(b.D,f);a.variable.animation.transition[g].cancel()})}}},{key:"initEvent",value:function(){var a;this.event=d._assistant.object.merge(null!==(a=this.option.event)&&void 0!==
a?a:{},d._event)}},{key:"bindEvent",value:function(){var a={once:!1,capture:!1,passive:!1,mozSystemGroup:!1};this.option.mask.enable&&this.option.mask.clickRemove&&(this.variable.eventSymbol.maskClickRemove=d._assistant.event.add(this.variable.nodes.mask,"click",null,this.event.clickMask,this,null,a));this.option.drag.enable&&(this.variable.eventSymbol.drag=d._assistant.event.add(this.variable.nodes.container.querySelector(".modal-layer-title"),"mousedown",null,this.event.drag,this,null,a));this.option.resize.enable&&
(this.variable.eventSymbol.resize=d._assistant.event.add(this.variable.nodes.container,"mousedown",".modal-layer-resize-bar",this.event.resize,this,null,a));this.variable.eventSymbol.active=d._assistant.event.add(this.variable.nodes.container,"mousedown",null,this.event.active,this,null,a);this.event.action.close instanceof Function&&(this.variable.eventSymbol.actionClose=d._assistant.event.add(this.variable.nodes.container,"click",".modal-layer-action-btn-close",this.event.action.close,this,null,
...
var c=this.variable.nodes.container.querySelector(".modal-layer-interaction-btn-no");var e=this.variable.nodes.container.querySelector(".modal-layer-interaction-btn-cancel");this.event.interaction.ok&&b&&(this.variable.eventSymbol.interactionOk=d._assistant.event.add(b,"click",null,this.event.interaction.ok,this,null,a));this.event.interaction.no&&c&&(this.variable.eventSymbol.interactionNo=d._assistant.event.add(c,"click",null,this.event.interaction.no,this,null,a));e&&(this.variable.eventSymbol.interactionCancel=
d._assistant.event.add(e,"click",null,this.event.interaction.cancel,this,null,a))}},{key:"insertNode",value:function(){var a,b=this,c=document.createDocumentFragment(),e=null!==(a=this.option.window)&&void 0!==a?a:window.document.body;Object.keys(this.variable.nodes).forEach(function(f){return c.appendChild(b.variable.nodes[f])},this);e.appendChild(c)}}]);O(d,[{key:"setStatus",value:function(a){if(Object.values(d._enum.STATUS).includes(a))var b=d._assistant.object.getKeyByValue(d._enum.STATUS,a);
else if(b=a.toUpperCase(),void 0===(a=d._enum.STATUS[b]))throw Error("Illegal value");this.status=a;this.variable.nodes.container.setAttribute("modal-layer-status",b.toLowerCase())}},{key:"resize",value:function(){var a=[0,0];var b=this.variable.nodes.container;var c=b.children;a[0]=d._assistant.number.multiply(window.innerWidth,this.option.areaProportion[0]);b.style.width=a[0]+"px";for(var e=0;e<c.length;e++)a[1]="absolute"==getComputedStyle(c[e]).position?a[1]:Math.max(d._assistant.element.getNodeHeight(c[e]),
a[1]);b.style.height=a[1]+"px";this.variable.defaultArea=a;this.variable.defaultRect.width=a[0];this.variable.defaultRect.height=a[1]}},{key:"resizeBy",value:function(a,b,c,e){var f=this.variable.nodes.container;f.style.cssText+="top: ".concat(b,"px; left: ").concat(a,"px; width: ").concat(c,"px; height: ").concat(e,"px;");[d._enum.TYPE.PAGE,d._enum.TYPE.VIDEO,d._enum.TYPE.AUDIO].includes(this.type)&&(f.querySelector("iframe[name="+this.option.layer.name+this.option.index+"]").style.cssText+="width: ".concat(this.option.layer.area[0]+
c-this.variable.defaultRect.width,"px; height: ").concat(this.option.layer.area[1]+e-this.variable.defaultRect.height,"px;"))}},{key:"positioning",value:function(){var a,b;var c=this.variable.nodes.container;var e=this.option.window===document.body?document.documentElement:this.option.window;if(this.option.position){var f=J(this.option.position);var g=f[0];f=f[1]}else{g=this.variable.defaultRect.width;var k=this.variable.defaultRect.height;f=null!==(a=null===e||void 0===e?void 0:e.scrollTop)&&void 0!==
a?a:0;a=null!==(b=null===e||void 0===e?void 0:e.scrollLeft)&&void 0!==b?b:0;b=e?e.clientWidth:window.innerWidth;e=e?e.clientHeight:window.innerHeight;g=d._assistant.number.chain(b).subtract(g).divide(2).add(a).floor().done();f=d._assistant.number.chain(e).subtract(k).divide(2).add(f).floor().done()}c.style.cssText+="top: ".concat(f,"px; left: ").concat(g,"px;");this.variable.defaultRect.top=f;this.variable.defaultRect.left=g}},{key:"show",value:function(){var a=this;var b=this.variable.nodes;var c=
Object.keys(b);var e=this.variable.animation.transition;var f=d._assistant.element.maxZIndex();if(0===Object.keys(b).length||this.status===d._enum.STATUS.SHOW)return Promise.resolve();var g=new Promise(function(k){function h(){0<a.option.popupTime&&a.event.autoShutdown.call(a);k()}null!==a.option.transition.animation?e.container.onfinish=h:h()});c.forEach(function(k){var h=0>e[k].playbackRate?"reverse":"play";b[k].style.zIndex=f+1;b[k].classList.contains("modal-layer-hide")&&b[k].classList.replace("modal-layer-hide",
"modal-layer-show");if(null===e||void 0===e?0:e[k])e[k][h]()});this.setStatus("show");return g}},{key:"hide",value:function(){var a=this;var b=this.variable.nodes;var c=Object.keys(b);var e=this.variable.animation.transition;if(0===Object.keys(b).length||this.status===d._enum.STATUS.HIDE)return Promise.resolve();Number.isInteger(this.variable.timeout.auto_shutdown)&&window.clearTimeout(this.variable.timeout.auto_shutdown);var f=new Promise(function(g){function k(){c.forEach(function(h){b[h].classList.contains("modal-layer-show")&&
b[h].classList.replace("modal-layer-show","modal-layer-hide")});a.option.parentModalLayer instanceof d&&a.option.parentModalLayer.show();a.setStatus("hide");g()}null!==a.option.transition.animation?e.container.onfinish=k:k()});c.forEach(function(g){var k=0<e[g].playbackRate?"reverse":"play";if(null===e||void 0===e?0:e[g])e[g][k]()});return f}},{key:"minimize",value:function(){var a=this;if(this.status!==d._enum.STATUS.MINIMIZE){var b=this.option.transition.duration;var c=document.querySelector("#modal-layer-minimize-queue");
...
f.classList.add(this.option.ui);f.setAttribute("modal-layer-index",this.option.index);f.querySelector(".modal-layer-minimize-queue-item-title").innerHTML=e;c.insertAdjacentElement("beforeend",f);(e=d._assistant.cache.get("minimizeQueueAnimations"))||(e=new Map,d._assistant.cache.set("minimizeQueueAnimations",e));(c=e.get(this.option.index))?c.reverse():(c=[{opacity:0,transform:"scale(.45)"},{opacity:1,transform:"scale(1)"}],b={fill:"both",id:"modal-layer-minimize-queue-transition-animation",easing:this.option.transition.easing,
duration:1E3*b},c=f.animate(c,b),e.set(this.option.index,c));this.hide().then(function(){return void a.setStatus("minimize")})}}},{key:"revert",value:function(){var a=this;var b=this.option.transition.duration;var c=document.querySelector("#modal-layer-minimize-queue");b=d._assistant.number.divide(b,2);var e=c.querySelector('.modal-layer-minimize-queue-item[modal-layer-index="'+this.option.index+'"]');if([d._enum.STATUS.MINIMIZE].includes(this.status)){var f=d._assistant.cache.get("minimizeQueueAnimations").get(this.option.index);
setTimeout(function(){a.show()},1E3*b);b=new Promise(function(g){f.onfinish=function(){e.remove();0>=d._minimizeQueue.length&&(c.remove(),d._assistant.cache.has("minimizeQueueEvent")&&d._assistant.event.remove(d._assistant.cache.get("minimizeQueueEvent")));f.onfinish=null;g()}});f.reverse();return b}}},{key:"remove",value:function(){var a=this;var b=this.status;var c=this.variable.nodes;b===d._enum.STATUS.MINIMIZE&&delete d._minimizeQueue[d._minimizeQueue.indexOf(this)];this.setStatus(d._enum.STATUS.REMOVING);
return 0===Object.keys(c).length||[d._enum.STATUS.HIDE,d._enum.STATUS.REMOVING,d._enum.STATUS.REMOVED].includes(b)?Promise.resolve():this.hide().then(function(){a.removeAllEvent();Object.keys(c).forEach(function(e){c[e].remove()});a.setStatus("removed")})}},{key:"delete",value:function(){var a=this;this.remove().then(function(){d.a.splice(d.a.indexOf(a),1);d._assistant.object.dereference(a.event);d._assistant.object.dereference(a.option);d._assistant.object.dereference(a.variable);a.event=a.option=
a.variable=null})}},{key:"removeAllEvent",value:function(){0!==Object.keys(this.variable.nodes).length&&Object.values(this.variable.eventSymbol).forEach(function(a){return d._assistant.event.remove(a)})}}],[{key:"removeAll",value:function(){for(var a=0;a<d._instance.length;a++)d._instance[a].remove()}},{key:"msg",value:function(a,b){d.message(a,b)}},{key:"message",value:function(a,b){"string"===typeof a?a={content:a,type:d._enum.TYPE.MESSAGE}:a.type=d._enum.TYPE.MESSAGE;a=new (d._achieve.get("message"))(a,
b);a.resize();a.positioning();a.show();return a}},{key:"alert",value:function(a,b){a.type=d._enum.TYPE.ALERT;a=new (d._achieve.get("alert"))(a,b);a.resize();a.positioning();a.show();return a}},{key:"confirm",value:function(a,b){a.type=d._enum.TYPE.CONFIRM;a=new (d._achieve.get("confirm"))(a,b);a.resize();a.positioning();a.show();return a}},{key:"prompt",value:function(a,b){a.type=d._enum.TYPE.PROMPT;a=new (d._achieve.get("prompt"))(a,b);a.resize();a.positioning();a.show();return a}},{key:"page",value:function(a,
b){a.type=d._enum.TYPE.PAGE;a=new (d._achieve.get("page"))(a,b);a.resize();a.positioning();a.show();return a}},{key:"image",value:function(a,b){var c=null;a.type=d._enum.TYPE.IMAGE;c=new (d._achieve.get("image"))(a,b);c.variable.image.finish.then(function(){c.resize();c.variable.image.layer.resize()}).then(function(){c.positioning();c.variable.image.layer.positioning()}).then(function(){return c.show()});return c}},{key:"loading",value:function(a,b){a.type=d._enum.TYPE.LOADING;a=new (d._achieve.get("loading"))(a,
b);a.resize();a.positioning();a.show();return a}}]);return d}();P(T,"_env",xa);P(T,"_enum",W);P(T,"_struct",V);P(T,"_option",U);P(T,"_variable",new Map);P(T,"_worker",window.Worker?new Map:void 0);P(T,"_event",S);P(T,"_version",1);P(T,"_achieve",new Map);P(T,"_assistant",Object.create(null));P(T,"_instance",new Proxy([],{set:function(d,a,b){if(b instanceof T||"length"===a)return d[a]=b,!0;throw new TypeError("Must be of type ModalLayer");}}));
