...
m("Array.from",function(d){return d?d:function(a,b,c){b=null!=b?b:function(k){return k};var e=[],f="undefined"!=typeof Symbol&&Symbol.iterator&&a[Symbol.iterator];if("function"==typeof f){a=f.call(a);for(var g=0;!(f=a.next()).done;)e.push(b.call(c,f.value,g++))}else for(f=a.length,g=0;g<f;g++)e.push(b.call(c,a[g],g));return e}});
...
m("String.prototype.includes",function(d){return d?d:function(a,b){return-1!==oa(this,a,"includes").indexOf(a,b||0)}});m("Number.isFinite",function(d){return d?d:function(a){return"number"!==typeof a?!1:!isNaN(a)&&Infinity!==a&&-Infinity!==a}});m("Number.isInteger",function(d){return d?d:function(a){return Number.isFinite(a)?a===Math.floor(a):!1}});function z(d,a){return Object.prototype.hasOwnProperty.call(d,a)}
m("Object.values",function(d){return d?d:function(a){var b=[],c;for(c in a)z(a,c)&&b.push(a[c]);return b}});function C(d){var a="undefined"!=typeof Symbol&&Symbol.iterator&&d[Symbol.iterator];return a?a.call(d):{next:la(d)}}
m("Promise",function(d){function a(g){this.c=0;this.i=void 0;this.a=[];var k=this.g();try{g(k.resolve,k.reject)}catch(h){k.reject(h)}}function b(){this.a=null}function c(g){return g instanceof a?g:new a(function(k){k(g)})}if(d)return d;b.prototype.c=function(g){if(null==this.a){this.a=[];var k=this;this.g(function(){k.i()})}this.a.push(g)};var e=ca.setTimeout;b.prototype.g=function(g){e(g,0)};b.prototype.i=function(){for(;this.a&&this.a.length;){var g=this.a;this.a=[];for(var k=0;k<g.length;++k){var h=
...
l.c);}}var l=this;null==this.a?f.c(h):this.a.push(h)};a.resolve=c;a.reject=function(g){return new a(function(k,h){h(g)})};a.race=function(g){return new a(function(k,h){for(var l=C(g),n=l.next();!n.done;n=l.next())c(n.value).j(k,h)})};a.all=function(g){var k=C(g),h=k.next();return h.done?c([]):new a(function(l,n){function u(v){return function(t){q[v]=t;r--;0==r&&l(q)}}var q=[],r=0;do q.push(void 0),r++,c(h.value).j(u(q.length-1),n),h=k.next();while(!h.done)})};return a});
m("WeakMap",function(d){function a(h){this.a=(k+=Math.random()+1).toString();if(h){h=C(h);for(var l;!(l=h.next()).done;)l=l.value,this.set(l[0],l[1])}}function b(){}function c(h){var l=typeof h;return"object"===l&&null!==h||"function"===l}function e(h){if(!z(h,g)){var l=new b;aa(h,g,{value:l})}}function f(h){var l=Object[h];l&&(Object[h]=function(n){if(n instanceof b)return n;Object.isExtensible(n)&&e(n);return l(n)})}if(function(){if(!d||!Object.seal)return!1;try{var h=Object.seal({}),l=Object.seal({}),
n=new d([[h,2],[l,3]]);if(2!=n.get(h)||3!=n.get(l))return!1;n.delete(h);n.set(l,4);return!n.has(h)&&4==n.get(l)}catch(u){return!1}}())return d;var g="$jscomp_hidden_"+Math.random();f("freeze");f("preventExtensions");f("seal");var k=0;a.prototype.set=function(h,l){if(!c(h))throw Error("Invalid WeakMap key");e(h);if(!z(h,g))throw Error("WeakMap key fail: "+h);h[g][this.a]=l;return this};a.prototype.get=function(h){return c(h)&&z(h,g)?h[g][this.a]:void 0};a.prototype.has=function(h){return c(h)&&z(h,
g)&&z(h[g],this.a)};a.prototype.delete=function(h){return c(h)&&z(h,g)&&z(h[g],this.a)?delete h[g][this.a]:!1};return a});
m("Map",function(d){function a(){var k={};return k.f=k.next=k.head=k}function b(k,h){var l=k.a;return ma(function(){if(l){for(;l.head!=k.a;)l=l.f;for(;l.next!=l.head;)return l=l.next,{done:!1,value:h(l)};l=null}return{done:!0,value:void 0}})}function c(k,h){var l=h&&typeof h;"object"==l||"function"==l?f.has(h)?l=f.get(h):(l=""+ ++g,f.set(h,l)):l="p_"+h;var n=k.c[l];if(n&&z(k.c,l))for(k=0;k<n.length;k++){var u=n[k];if(h!==h&&u.key!==u.key||h===u.key)return{id:l,list:n,index:k,b:u}}return{id:l,list:n,
index:-1,b:void 0}}function e(k){this.c={};this.a=a();this.size=0;if(k){k=C(k);for(var h;!(h=k.next()).done;)h=h.value,this.set(h[0],h[1])}}if(function(){if(!d||"function"!=typeof d||!d.prototype.entries||"function"!=typeof Object.seal)return!1;try{var k=Object.seal({x:4}),h=new d(C([[k,"s"]]));if("s"!=h.get(k)||1!=h.size||h.get({x:4})||h.set({x:4},"t")!=h||2!=h.size)return!1;var l=h.entries(),n=l.next();if(n.done||n.value[0]!=k||"s"!=n.value[1])return!1;n=l.next();return n.done||4!=n.value[0].x||
"t"!=n.value[1]||!l.next().done?!1:!0}catch(u){return!1}}())return d;var f=new WeakMap;e.prototype.set=function(k,h){k=0===k?0:k;var l=c(this,k);l.list||(l.list=this.c[l.id]=[]);l.b?l.b.value=h:(l.b={next:this.a,f:this.a.f,head:this.a,key:k,value:h},l.list.push(l.b),this.a.f.next=l.b,this.a.f=l.b,this.size++);return this};e.prototype.delete=function(k){k=c(this,k);return k.b&&k.list?(k.list.splice(k.index,1),k.list.length||delete this.c[k.id],k.b.f.next=k.b.next,k.b.next.f=k.b.f,k.b.head=null,this.size--,
!0):!1};e.prototype.clear=function(){this.c={};this.a=this.a.f=a();this.size=0};e.prototype.has=function(k){return!!c(this,k).b};e.prototype.get=function(k){return(k=c(this,k).b)&&k.value};e.prototype.entries=function(){return b(this,function(k){return[k.key,k.value]})};e.prototype.keys=function(){return b(this,function(k){return k.key})};e.prototype.values=function(){return b(this,function(k){return k.value})};e.prototype.forEach=function(k,h){for(var l=this.entries(),n;!(n=l.next()).done;)n=n.value,
k.call(h,n[1],n[0],this)};e.prototype[Symbol.iterator]=e.prototype.entries;var g=0;return e});
m("Set",function(d){function a(b){this.a=new Map;if(b){b=C(b);for(var c;!(c=b.next()).done;)this.add(c.value)}this.size=this.a.size}if(function(){if(!d||"function"!=typeof d||!d.prototype.entries||"function"!=typeof Object.seal)return!1;try{var b=Object.seal({x:4}),c=new d(C([b]));if(!c.has(b)||1!=c.size||c.add(b)!=c||1!=c.size||c.add({x:4})!=c||2!=c.size)return!1;var e=c.entries(),f=e.next();if(f.done||f.value[0]!=b||f.value[1]!=b)return!1;f=e.next();return f.done||f.value[0]==b||4!=f.value[0].x||
...
var pa="function"==typeof Object.assign?Object.assign:function(d,a){for(var b=1;b<arguments.length;b++){var c=arguments[b];if(c)for(var e in c)z(c,e)&&(d[e]=c[e])}return d};m("Object.assign",function(d){return d||pa});m("Array.prototype.fill",function(d){return d?d:function(a,b,c){var e=this.length||0;0>b&&(b=Math.max(0,e+b));if(null==c||c>e)c=e;c=Number(c);0>c&&(c=Math.max(0,e+c));for(b=Number(b||0);b<c;b++)this[b]=a;return this}});function D(d){return d?d:Array.prototype.fill}
m("Int8Array.prototype.fill",D);m("Uint8Array.prototype.fill",D);m("Uint8ClampedArray.prototype.fill",D);m("Int16Array.prototype.fill",D);m("Uint16Array.prototype.fill",D);m("Int32Array.prototype.fill",D);m("Uint32Array.prototype.fill",D);m("Float32Array.prototype.fill",D);m("Float64Array.prototype.fill",D);
...
function J(d){var a=Array.isArray(d)?d:void 0;if(!a)if("undefined"!==typeof Symbol&&Symbol.iterator in Object(d)){a=[];var b=!0,c=!1,e=void 0;try{for(var f=d[Symbol.iterator](),g;!(b=(g=f.next()).done)&&(a.push(g.value),2!==a.length);b=!0);}catch(k){c=!0,e=k}finally{try{if(!b&&null!=f["return"])f["return"]()}finally{if(c)throw e;}}}else a=void 0;if(!(d=a||ua(d,2)))throw new TypeError("Invalid attempt to destructure non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method.");
...
t?void 0:t.paddingBottom)&&void 0!==v?v:0);var w=[0,h.offsetWidth-b-e-c-f,0,h.offsetHeight-d-g-a-k];if(this.option.position)r.y=q.offsetTop,r.x=q.offsetLeft;else{var y,p;r.y+=null!==(y=null===h||void 0===h?void 0:h.scrollTop)&&void 0!==y?y:0;r.x+=null!==(p=null===h||void 0===h?void 0:h.scrollLeft)&&void 0!==p?p:0}}else w=[0,document.documentElement.clientWidth,0,document.documentElement.clientHeight];window.getSelection().empty();var B=function(L,x){r.x+=L;r.y+=x;if(!l.option.drag.overflow){if(r.x<
w[0]||r.x>w[1]-r.width)r.x-=L;if(r.y<w[2]||r.y>w[3]-r.height)r.y-=x}l.resizeBy(r.x,r.y,r.width,r.height);l.setStatus(T._enum.STATUS.DRAG)};var I=function(L){n=null!==L&&void 0!==L?L:window.event;1===n.buttons&&B(n.movementX,n.movementY)};var Q=function(L){var x;var A=[0,0];L=null!==(x=L)&&void 0!==x?x:window.event;"ArrowLeft"===L.code&&(A[0]=-1);"ArrowRight"===L.code&&(A[0]=1);"ArrowUp"===L.code&&(A[1]=-1);"ArrowDown"===L.code&&(A[1]=1);L.preventDefault();B.apply(void 0,R(A))};var X=function(){document.removeEventListener("keydown",
Q,!0);document.removeEventListener("mousemove",I);document.removeEventListener("mouseup",X);l.setStatus(u)};document.addEventListener("mouseup",X);document.addEventListener("mousemove",I);document.addEventListener("keydown",Q,!0)}});
Object.defineProperty(S,"resize",{enumerable:!0,value:function(d){var a,b,c,e,f,g,k,h=this;var l=this.status;d=null!==(e=d)&&void 0!==e?e:window.event;var n=d.target;var u=this.variable.nodes.container;var q=u.getBoundingClientRect();e=this.option.window===document.body?document.documentElement:this.option.window;var r=this.option.window?window.getComputedStyle(this.option.window):null;d=parseInt(null!==(a=null===r||void 0===r?void 0:r.marginTop)&&void 0!==a?a:0);a=parseInt(null!==(b=null===r||void 0===
r?void 0:r.paddingTop)&&void 0!==b?b:0);b=parseInt(null!==(c=null===r||void 0===r?void 0:r.marginLeft)&&void 0!==c?c:0);c=parseInt(null!==(f=null===r||void 0===r?void 0:r.paddingLeft)&&void 0!==f?f:0);var v=null!==(g=null===e||void 0===e?void 0:e.offsetWidth)&&void 0!==g?g:window.innerWidth;var t=null!==(k=null===e||void 0===e?void 0:e.offsetHeight)&&void 0!==k?k:window.innerHeight;window.getSelection().empty();this.option.position?(q.y=u.offsetTop,q.x=u.offsetLeft):(q.y+=e?e.scrollTop-d-a:0,q.x+=
e?e.scrollLeft-b-c:0);var w=function(p){var B;p=null!==(B=p)&&void 0!==B?B:window.event;1!==p.buttons?y():(h.setStatus("resize"),B=n.getAttribute("position-resize-bar"),B.includes("top")&&0<q.y+p.movementY&&q.height-p.movementY>h.variable.defaultRect.height&&(q.y+=p.movementY,q.height-=p.movementY),B.includes("bottom")&&(q.height+=p.movementY,q.y+q.height>t||q.height<h.variable.defaultRect.height)&&(q.height-=p.movementY),B.includes("left")&&0<q.x+p.movementX&&q.width-p.movementX>h.variable.defaultRect.width&&
(q.x+=p.movementX,q.width-=p.movementX),B.includes("right")&&(q.width+=p.movementX,q.x+q.width>v||q.width<h.variable.defaultRect.width)&&(q.width-=p.movementX),h.resizeBy(q.x,q.y,q.width,q.height))};var y=function(){document.removeEventListener("mousemove",w);document.removeEventListener("mouseup",y);h.setStatus(l)};document.addEventListener("mouseup",y);document.addEventListener("mousemove",w)}});
...
Object.defineProperty(S,"action",{enumerable:!0,value:{close:function(){void this.remove()},expand:function(){var d=this;var a=this.status;var b=this.variable.nodes.container.querySelector("iframe[name="+this.option.layer.name+this.option.index+"]");var c=function(f){f.target===b?d.setStatus(T._enum.STATUS.EXPAND):!1===f.target&&d.setStatus(a);window.removeEventListener("fullscreenerror",e);window.removeEventListener("fullscreenchange",c)};var e=function(f){T.L({K:!1,M:5,title:"\u9519\u8bef",I:!0,
J:"bottom",content:'<i class="fas fa-window-close" style="color: red"></i> \u5168\u5c4f\u5931\u8d25, \u9519\u8bef\u539f\u56e0: '+f});window.removeEventListener("fullscreenerror",e);window.removeEventListener("fullscreenchange",c)};window.addEventListener("fullscreenerror",e);window.addEventListener("fullscreenchange",c);T._assistant.element.launchFullscreen(b)},minimize:function(){var d=T._minimizeQueue.indexOf(this);0>d?T._minimizeQueue.push(this):T._minimizeQueue.splice(d,1)}}});
...
enumerable:!0,configurable:!1});Object.freeze(V);var W=Object.create(null);Object.defineProperty(W,"ARROW",{enumerable:!0,value:{LEFT:37,UP:38,RIGHT:39,DOWN:40}});Object.defineProperty(W,"DIRECTION",{enumerable:!0,value:{EAST:"e",WEST:"w",SOUTH:"s",NORTH:"n"}});Object.defineProperty(W,"POSITION",{enumerable:!0,value:{CENTER:null,LEFT_TOP:"lt",RIGHT_TOP:"rt",LEFT_BOTTOM:"lb",RIGHT_BOTTOM:"rb"}});
Object.defineProperty(W,"TYPE",{enumerable:!0,value:{MSG:0,MESSAGE:0,ALERT:1,PROMPT:2,CONFIRM:3,PAGE:4,LOADING:5,IMAGE:6,VIDEO:7,AUTDIO:8}});Object.defineProperty(W,"STATUS",{enumerable:!0,value:{HIDE:0,SHOW:1,EXPAND:2,MINIMIZE:3,REMOVING:4,REMOVED:5,DRAG:6,RESIZE:7}});Object.defineProperty(W,"LOAD_STATUS",{enumerable:!0,value:{FAILED:0,LOADED:1,LOADING:2}});Object.defineProperty(W,"BROWSER_STORAGE",{enumerable:!0,value:{WEBSQL:"webSQL",INDEXDB:"indexedDB",LOCALSTORAGE:"localStorage",SESSIONSTORAGE:"sessionStorage"}});
...
var T=function(){function d(a,b){K(this,d);P(this,"type",null);P(this,"status",null);P(this,"event",null);P(this,"option",null);P(this,"variable",{});try{var c,e,f,g,k,h;null===(c=a.hook)||void 0===c?void 0:null===(e=c.initStart)||void 0===e?void 0:null===(f=e.call)||void 0===f?void 0:f.call(e,a);this.type=a.type;this.status=d._enum.STATUS.HIDE;this.compatibleOption(a);this.initOption(a);this.checkOption();this.linkageOption();this.initVariable();this.initStruct();this.initNode();this.initAttribute();
this.initAnimation();this.initEvent();this.bindEvent();null===(g=this.option.hook)||void 0===g?void 0:null===(k=g.initEnded)||void 0===k?void 0:null===(h=k.call)||void 0===h?void 0:h.call(k,this);this.insertNode()}catch(l){return null===b||void 0===b?void 0:b.call(this,l),this["delete"](),l}}O(d,[{key:"initOption",value:function(a){a.index=d._instance.length;d._instance[a.index]=this;this.option=d._assistant.object.merge(a,d._option.common)}},{key:"compatibleOption",value:function(a){var b,c;d._assistant.object.isString(a.window)&&
(a.window=document.querySelector(a.window));a.position&&(Array.isArray(a.position)||Number.isInteger(a.position)&&(a.position=[a.position,a.position]));if("boolean"===typeof a.mask||["true","false"].includes(a.mask))a.mask={enable:!!a.mask,clickRemove:!0};d._assistant.object.isOnlyObject(a.content)||(a.content={value:a.content,fullContainer:null!==(b=null===(c=a.content)||void 0===c?void 0:c.fullContainer)&&void 0!==b?b:!1})}},{key:"linkageOption",value:function(){0>=this.option.popupTime&&(this.option.progress.enable=
!1);!1===this.option.title&&(this.option.drag.enable=!1)}},{key:"checkOption",value:function(){if(this.option.window&&!(this.option.window instanceof Element))throw new TypeError("option.window does not meet the expected value.");if(Number.isFinite(this.option.transition.animation)){if(!Object.values(d._enum.TRANSITION_ANIMATION_PRESET).includes(this.option.transition.animation))throw Error("No preset animation found.");}else if(null!==this.option.transition.animation&&!(Array.isArray(this.option.transition.animation)||
this.option.transition.animation instanceof Animation))throw Error("Expects a css animation name or Animation object.");if(this.option.position&&!Array.isArray(this.option.position)&&!Object.values(d._enum.POSITION).includes(this.option.position))throw Error("option.position does not meet the expected value.");}},{key:"initVariable",value:function(){this.variable.struct=Object.create(null);this.variable.timeout=Object.create(null);this.variable.interval=Object.create(null);this.variable.animation=
Object.create(null);this.variable.eventSymbol=Object.create(null);this.variable.defaultRect=Object.create(null);this.variable.struct._build=Object.create(null);this.variable.struct._backup=Object.create(null)}},{key:"initStruct",value:function(){var a;if(null===(a=this.option.mask)||void 0===a?0:a.enable)this.variable.struct._build.mask=d._struct.mask;this.variable.struct._build.container=d._struct.container}},{key:"initNode",value:function(){this.variable.nodes=d._assistant.element.objectToNode(this.variable.struct._build);
var a=this.variable.nodes.mask;var b=this.variable.nodes.container;var c=b.querySelector(".modal-layer-interaction-btn-ok");var e=b.querySelector(".modal-layer-interaction-btn-no");var f=b.querySelector(".modal-layer-interaction-btn-cancel");null!==this.option.window&&(null===a||void 0===a?void 0:a.setAttribute("has-window",""),b.setAttribute("has-window",""));b.setAttribute("modal-layer-popup-time",this.option.popupTime);b.setAttribute("content-full-container",Number(this.option.content.fullContainer));
b.setAttribute("modal-layer-type",d._assistant.object.getKeyByValue(d._enum.TYPE,this.type).toLowerCase());b.setAttribute("allow-drag",Number(this.option.drag.enable));b.setAttribute("allow-resize",Number(this.option.resize.enable));if(this.option.progress.enable){a=["top","left","right","bottom"];var g=b.querySelector(".modal-layer-progress-bar");a.includes(this.option.progress.position)||(this.option.progress.position=a[3]);g.setAttribute("progress-bar-position",this.option.progress.position);g.querySelector(".modal-layer-progress-bar-progress").style.cssText+=
"background: "+this.option.progress.color;g.querySelector(".modal-layer-progress-bar-background").style.cssText+="background: "+this.option.progress.background}if(!1!==this.option.title){var k=b.querySelector(".modal-layer-title-content");if(this.option.title instanceof Object){var h=d._assistant.element.objectToNode(this.option.title);Object.keys(h).forEach(function(l){k.appendChild(h[l])})}else k.innerHTML=this.option.title}c&&(c.innerText=this.option.text.interaction.ok);e&&(e.innerText=this.option.text.interaction.no);
f&&(f.innerText=this.option.text.interaction.cancel)}},{key:"initAttribute",value:function(){var a=this.option.ui;var b="modal-layer-skin-"+this.option.skin;var c="modal-layer-index-"+this.option.index;Object.keys(this.variable.nodes).forEach(function(e){for(var f=d._assistant.element.getAllElement(this.variable.nodes[e]),g=0;g<f.length;g++)f[g].classList.contains(a)&&f[g].classList.remove(a),f[g].className="".concat(a," ").concat(f[g].className);this.variable.nodes[e].className=a+" "+b+" "+c+" "+
this.variable.nodes[e].className.trim()+" modal-layer-hide"},this)}},{key:"initAnimation",value:function(){var a=this;var b=Object.create(null);var c=this.variable.nodes;if(null!==this.option.transition.animation){var e=this.option.transition.animation;b.D=[{opacity:0},{opacity:1}];b.container=[[{opacity:0,transform:"scale(.45)"},{opacity:1,transform:"scale(1)"}],[{opacity:0,transform:"translateY(-100%)"},{opacity:1,transform:"translateY(0)"}],[{opacity:0,transform:"rotateY(-120deg)"},{opacity:1,
transform:"rotateY(0)"}],[{opacity:0,transform:"skewX(-100deg)"},{opacity:1,transform:"skewX(0deg)"}],[{opacity:0,transform:"translateY(200%) scale(.45)"},{opacity:1,transform:"translateY(0) scale(1)"}]];var f={fill:"both",id:"modal-layer-transition-animation",easing:this.option.transition.easing,duration:1E3*this.option.transition.duration};this.variable.animation.transition=Object.create(null);Object.keys(c).forEach(function(g){"container"===g?(e instanceof Animation?e.effect.target=c[g]:(e=Array.isArray(e)?
e:b[g][e],e=c[g].animate(e,f)),a.variable.animation.transition[g]=e):a.variable.animation.transition[g]=c[g].animate(b.D,f);a.variable.animation.transition[g].cancel()})}}},{key:"initEvent",value:function(){var a;this.event=d._assistant.object.merge(null!==(a=this.option.event)&&void 0!==a?a:{},d._event)}},{key:"bindEvent",value:function(){var a={once:!1,capture:!1,passive:!1,mozSystemGroup:!1};this.option.mask.enable&&this.option.mask.clickRemove&&(this.variable.eventSymbol.maskClickRemove=d._assistant.event.add(this.variable.nodes.mask,
"click",null,this.event.clickMask,this,null,a));this.option.drag.enable&&(this.variable.eventSymbol.drag=d._assistant.event.add(this.variable.nodes.container.querySelector(".modal-layer-title"),"mousedown",null,this.event.drag,this,null,a));this.option.resize.enable&&(this.variable.eventSymbol.resize=d._assistant.event.add(this.variable.nodes.container,"mousedown",".modal-layer-resize-bar",this.event.resize,this,null,a));this.variable.eventSymbol.active=d._assistant.event.add(this.variable.nodes.container,
"mousedown",null,this.event.active,this,null,a);this.event.action.close instanceof Function&&(this.variable.eventSymbol.actionClose=d._assistant.event.add(this.variable.nodes.container,"click",".modal-layer-action-btn-close",this.event.action.close,this,null,a));this.event.action.expand instanceof Function&&(this.variable.eventSymbol.actionExpand=d._assistant.event.add(this.variable.nodes.container,"click",".modal-layer-action-btn-expand",this.event.action.expand,this,null,a));this.event.action.minimize instanceof
Function&&(this.variable.eventSymbol.actionMinimize=d._assistant.event.add(this.variable.nodes.container,"click",".modal-layer-action-btn-minimize",this.event.action.minimize,this,null,a));var b=this.variable.nodes.container.querySelector(".modal-layer-interaction-btn-ok");var c=this.variable.nodes.container.querySelector(".modal-layer-interaction-btn-no");var e=this.variable.nodes.container.querySelector(".modal-layer-interaction-btn-cancel");this.event.interaction.ok&&b&&(this.variable.eventSymbol.interactionOk=
d._assistant.event.add(b,"click",null,this.event.interaction.ok,this,null,a));this.event.interaction.no&&c&&(this.variable.eventSymbol.interactionNo=d._assistant.event.add(c,"click",null,this.event.interaction.no,this,null,a));e&&(this.variable.eventSymbol.interactionCancel=d._assistant.event.add(e,"click",null,this.event.interaction.cancel,this,null,a))}},{key:"insertNode",value:function(){var a,b=this,c=document.createDocumentFragment(),e=null!==(a=this.option.window)&&void 0!==a?a:window.document.body;
Object.keys(this.variable.nodes).forEach(function(f){return c.appendChild(b.variable.nodes[f])},this);e.appendChild(c)}}]);O(d,[{key:"setStatus",value:function(a){if(Object.values(d._enum.STATUS).includes(a))var b=d._assistant.object.getKeyByValue(d._enum.STATUS,a);else if(b=a.toUpperCase(),void 0===(a=d._enum.STATUS[b]))throw Error("Illegal value");this.status=a;this.variable.nodes.container.setAttribute("modal-layer-status",b.toLowerCase())}},{key:"resize",value:function(){var a=[0,0];var b=this.variable.nodes.container;
if(null===this.option.areaProportion)a=[b.offsetWidth,b.offsetHeight];else{var c=b.children;a[0]=d._assistant.number.multiply(window.innerWidth,this.option.areaProportion[0]);b.style.width=a[0]+"px";for(var e=0;e<c.length;e++)a[1]="absolute"==getComputedStyle(c[e]).position?a[1]:Math.max(d._assistant.element.getNodeHeight(c[e]),a[1]);b.style.height=a[1]+"px"}this.variable.defaultArea=a;this.variable.defaultRect.width=a[0];this.variable.defaultRect.height=a[1]}},{key:"resizeBy",value:function(a,b,
c,e){var f=this.variable.nodes.container;f.style.cssText+="top: ".concat(b,"px; left: ").concat(a,"px; width: ").concat(c,"px; height: ").concat(e,"px;");[d._enum.TYPE.PAGE,d._enum.TYPE.VIDEO,d._enum.TYPE.AUDIO].includes(this.type)&&(f.querySelector("iframe[name="+this.option.layer.name+this.option.index+"]").style.cssText+="width: ".concat(this.option.layer.area[0]+c-this.variable.defaultRect.width,"px; height: ").concat(this.option.layer.area[1]+e-this.variable.defaultRect.height,"px;"))}},{key:"positioning",
value:function(){var a,b;var c=this.variable.nodes.container;var e=this.option.window===document.body?document.documentElement:this.option.window;if(Array.isArray(this.option.position)){var f=J(this.option.position);var g=f[0];f=f[1]}else if(d._enum.POSITION.LEFT_TOP===this.option.position)g=f=0;else if(d._enum.POSITION.RIGHT_TOP===this.option.position)f=0,g=(e?e.offsetWidth:window.innerWidth)-c.offsetWidth;else if(d._enum.POSITION.LEFT_BOTTOM===this.option.position)g=0,f=(e?e.offsetHeight:window.innerHeight)-
c.offsetHeight;else if(d._enum.POSITION.RIGHT_BOTTOM===this.option.position)g=(e?e.offsetWidth:window.innerWidth)-c.offsetWidth,f=(e?e.offsetHeight:window.innerHeight)-c.offsetHeight;else{g=this.variable.defaultRect.width;var k=this.variable.defaultRect.height;f=null!==(a=null===e||void 0===e?void 0:e.scrollTop)&&void 0!==a?a:0;a=null!==(b=null===e||void 0===e?void 0:e.scrollLeft)&&void 0!==b?b:0;b=e?e.clientWidth:window.innerWidth;e=e?e.clientHeight:window.innerHeight;g=d._assistant.number.chain(b).subtract(g).divide(2).add(a).floor().done();
f=d._assistant.number.chain(e).subtract(k).divide(2).add(f).floor().done()}c.style.cssText+="top: ".concat(f,"px; left: ").concat(g,"px;");this.variable.defaultRect.top=f;this.variable.defaultRect.left=g}},{key:"show",value:function(){var a=this;var b=this.variable.nodes;if(!b||0===Object.keys(b).length||this.status===d._enum.STATUS.SHOW)return Promise.resolve();var c=Object.keys(b);var e=this.variable.animation.transition;var f=d._assistant.element.maxZIndex();var g=new Promise(function(k){function h(){0<
a.option.popupTime&&a.event.autoShutdown.call(a);k()}null!==a.option.transition.animation?e.container.onfinish=h:h()});c.forEach(function(k){var h=0>e[k].playbackRate?"reverse":"play";b[k].style.zIndex=f+1;b[k].classList.contains("modal-layer-hide")&&b[k].classList.replace("modal-layer-hide","modal-layer-show");if(null===e||void 0===e?0:e[k])e[k][h]()});this.setStatus("show");return g}},{key:"hide",value:function(){var a=this;var b=this.variable.nodes;if(!b||0===Object.keys(b).length||this.status===
d._enum.STATUS.HIDE)return Promise.resolve();var c=Object.keys(b);var e=this.variable.animation.transition;Number.isInteger(this.variable.timeout.auto_shutdown)&&window.clearTimeout(this.variable.timeout.auto_shutdown);var f=new Promise(function(g){function k(){c.forEach(function(h){b[h].classList.contains("modal-layer-show")&&b[h].classList.replace("modal-layer-show","modal-layer-hide")});a.option.parentModalLayer instanceof d&&a.option.parentModalLayer.show();a.setStatus("hide");g()}null!==a.option.transition.animation?
e.container.onfinish=k:k()});c.forEach(function(g){var k=0<e[g].playbackRate?"reverse":"play";if(null===e||void 0===e?0:e[g])e[g][k]()});return f}},{key:"minimize",value:function(){var a=this;if(this.status!==d._enum.STATUS.MINIMIZE){var b=this.option.transition.duration;var c=document.querySelector("#modal-layer-minimize-queue");c||(c=d._assistant.element.objectToNode([d._struct.minimize_queue])[0],c.classList.add(this.option.ui,"modal-layer-skin-".concat(this.option.skin)),d._assistant.cache.set("minimizeQueueEvent",
d._assistant.event.add(c,"click",".modal-layer-minimize-queue-item",this.event.minimizeRevert,null,null,!1)),document.body.insertAdjacentElement("beforeend",c));var e=this.variable.nodes.container.querySelector(".modal-layer-title-content").innerHTML;var f=d._assistant.element.objectToNode([d._struct.minimize_queue_item])[0];f.classList.add(this.option.ui);f.setAttribute("modal-layer-index",this.option.index);f.querySelector(".modal-layer-minimize-queue-item-title").innerHTML=e;c.insertAdjacentElement("beforeend",
f);(e=d._assistant.cache.get("minimizeQueueAnimations"))||(e=new Map,d._assistant.cache.set("minimizeQueueAnimations",e));(c=e.get(this.option.index))?c.reverse():(c=[{opacity:0,transform:"scale(.45)"},{opacity:1,transform:"scale(1)"}],b={fill:"both",id:"modal-layer-minimize-queue-transition-animation",easing:this.option.transition.easing,duration:1E3*b},c=f.animate(c,b),e.set(this.option.index,c));this.hide().then(function(){return void a.setStatus("minimize")})}}},{key:"revert",value:function(){var a=
this;if([d._enum.STATUS.MINIMIZE].includes(this.status)){var b=this.option.transition.duration;var c=document.querySelector("#modal-layer-minimize-queue");b=d._assistant.number.divide(b,2);var e=c.querySelector('.modal-layer-minimize-queue-item[modal-layer-index="'+this.option.index+'"]');var f=d._assistant.cache.get("minimizeQueueAnimations").get(this.option.index);setTimeout(function(){a.show()},1E3*b);b=new Promise(function(g){f.onfinish=function(){e.remove();0>=d._minimizeQueue.length&&(c.remove(),
d._assistant.cache.has("minimizeQueueEvent")&&d._assistant.event.remove(d._assistant.cache.get("minimizeQueueEvent")));f.onfinish=null;g()}});f.reverse();return b}}},{key:"remove",value:function(){var a=this;var b=this.status;var c=this.variable.nodes;b===d._enum.STATUS.MINIMIZE&&delete d._minimizeQueue[d._minimizeQueue.indexOf(this)];if(!c||0===Object.keys(c).length||[d._enum.STATUS.HIDE,d._enum.STATUS.REMOVING,d._enum.STATUS.REMOVED].includes(b))return Promise.resolve();this.setStatus(d._enum.STATUS.REMOVING);
return this.hide().then(function(){a.removeAllEvent();Object.keys(c).forEach(function(e){c[e].remove()});a.setStatus("removed")})}},{key:"delete",value:function(){var a=this;this.remove().then(function(){d.a.splice(d.a.indexOf(a),1);d._assistant.object.dereference(a.event);d._assistant.object.dereference(a.option);d._assistant.object.dereference(a.variable);a.event=a.option=a.variable=null})}},{key:"removeAllEvent",value:function(){0!==Object.keys(this.variable.nodes).length&&Object.values(this.variable.eventSymbol).forEach(function(a){return d._assistant.event.remove(a)})}}],
[{key:"removeAll",value:function(){for(var a=0;a<d._instance.length;a++)d._instance[a].remove()}},{key:"msg",value:function(a,b){return d.message(a,b)}},{key:"message",value:function(a,b){"string"===typeof a?a={content:a,type:d._enum.TYPE.MESSAGE}:a.type=d._enum.TYPE.MESSAGE;a=new (d._achieve.get("message"))(a,b);if(!(a instanceof Error))return a.resize(),a.positioning(),a.show(),a}},{key:"alert",value:function(a,b){a.type=d._enum.TYPE.ALERT;a=new (d._achieve.get("alert"))(a,b);if(!(a instanceof Error))return a.resize(),
a.positioning(),a.show(),a}},{key:"confirm",value:function(a,b){a.type=d._enum.TYPE.CONFIRM;a=new (d._achieve.get("confirm"))(a,b);if(!(a instanceof Error))return a.resize(),a.positioning(),a.show(),a}},{key:"prompt",value:function(a,b){a.type=d._enum.TYPE.PROMPT;a=new (d._achieve.get("prompt"))(a,b);if(!(a instanceof Error))return a.resize(),a.positioning(),a.show(),a}},{key:"page",value:function(a,b){a.type=d._enum.TYPE.PAGE;a=new (d._achieve.get("page"))(a,b);if(!(a instanceof Error))return a.resize(),
a.positioning(),a.show(),a}},{key:"image",value:function(a,b){var c=null;a.type=d._enum.TYPE.IMAGE;c=new (d._achieve.get("image"))(a,b);if(!(c instanceof Error))return c.variable.image.finish.then(function(){c.resize();c.variable.image.layer.resize()}).then(function(){c.positioning();c.variable.image.layer.positioning()}).then(function(){return c.show()}),c}},{key:"loading",value:function(a,b){a.type=d._enum.TYPE.LOADING;a=new (d._achieve.get("loading"))(a,b);if(!(a instanceof Error))return a.resize(),
a.positioning(),a.show(),a}}]);return d}();P(T,"_env",xa);P(T,"_enum",W);P(T,"_struct",V);P(T,"_option",U);P(T,"_variable",new Map);P(T,"_worker",window.Worker?new Map:void 0);P(T,"_event",S);P(T,"_version",1);P(T,"_achieve",new Map);P(T,"_assistant",Object.create(null));P(T,"_instance",new Proxy([],{set:function(d,a,b){if(b instanceof T||"length"===a)return d[a]=b,!0;throw new TypeError("Must be of type ModalLayer");}}));
...
Object.is(window.ModalLayer,T)?(console.group("ModalLayer already exists"),console.warn("Already version ".concat(window.ModalLayer._version)),console.warn("Try to introduce version: ".concat(T._version)),console.groupEnd()):(Object.preventExtensions(T),Object.defineProperty(window,"ModalLayer",{value:T}));
...
var za=function(){function d(){K(this,d)}O(d,null,[{key:"add",value:function(a,b,c,e,f,g,k){var h,l=7<arguments.length&&void 0!==arguments[7]?arguments[7]:!1,n;var u=!1;var q=Symbol();(n=Z.get("cache",d))||(n=new Map,Z.set("cache",n,d));if(!(a instanceof EventTarget||(a=document.querySelector(a))))throw Error("Is not a valid element.");if(!Y.isString(b))throw Error("Event type not allowed to be empty");c instanceof EventTarget&&(a=c,c=null);e instanceof Function||(u=!0);Y.isEmpty(f)&&(f=null!==(h=
c)&&void 0!==h?h:a);Y.isEmpty(g)||Array.isArray(g)||(g=[g]);Y.isEmpty(k)&&(k=!1);if(u){var r;g=[{target:f,symbol:q,parameter:null!==(r=g)&&void 0!==r?r:[]}]}else{var v;g=null!==(v=g)&&void 0!==v?v:[]}h=c?new Promise(function(t){function w(y){var p=(null!==y&&void 0!==y?y:window.event).target;var B=a.querySelectorAll(c);if(p.contains(a)||0===B.length)return!1;for(var I=0;I<B.length;I++){var Q=B[I];if(Q.contains(p)){p=Q===p?p:Q;u?(g[0].event=y,g[0].target=f===c?p:f):0<g.length&&g[g.length-1]instanceof
Event?g[g.length-1]=y:g.push(y);(u?t:e).apply(f===c?p:f,g);break}}}n.set(q,{type:b,element:a,options:k,selector:c,callback:w,wantsUntrusted:l});a.addEventListener(b,w,k,l)}):new Promise(function(t){var w;e=(w=u?t:e).bind.apply(w,[f].concat(R(g)));n.set(q,{type:b,element:a,options:k,selector:c,callback:e,wantsUntrusted:l});a.addEventListener(b,e,k,l)});return u?h:q}},{key:"remove",value:function(a){var b;var c=Z.get("cache",d);if(b=null===c||void 0===c?void 0:c.get(a))b.element.removeEventListener(b.type,
...
b.callback,b.options,b.wantsUntrusted);a["delete"](c)})}}]);return d}();Object.defineProperty(T._assistant,"event",{value:za});
...
var Y=function(){function d(){K(this,d)}O(d,null,[{key:"dereference",value:function(a){a&&Object.keys(a).forEach(function(b){var c=a[b];if(d.isCollection(c))if(d.dereference(c),c instanceof Map)a["delete"](b);else if(c instanceof Set)a["delete"](c);else a[b]=null;else a[b]=null})}},{key:"get",value:function(a,b){b=Array.isArray(b)?b:b.split(".");for(var c=0;c<b.length&&!d.isEmpty(a);c++)a=a[b[c]];return a}},{key:"set",value:function(a,b,c){b=Array.isArray(b)?b:b.split(".");for(var e=0;e<b.length;a=
a[b[e]],e++)d.isEmpty(a[b[e]])&&(a[b[e]]={}),e===b.length-1&&(a instanceof Map?a.set(b[e],c):Object.defineProperty(a,b[e],{value:c,writable:!0,enumerable:!0,configurable:!0}))}},{key:"isEmpty",value:function(a){return null===a||void 0===a}},{key:"isString",value:function(a){return"string"===typeof a||a instanceof String}},{key:"isCollection",value:function(a){var b=[Map,Set,Array,WeakMap,WeakSet,Int8Array,Uint8Array,Int16Array,Int32Array,Uint16Array,Uint32Array,Float32Array,Float64Array,Uint8ClampedArray];
...
do{a=b.shift();var f=c.shift();var g=J(f);f=g[0];var k=g[1];for(var h=0;h<f.length;h++){g=f[h];var l=k[h];if(d.isCollection(l)){var n,u,q;a[g]=null!==(n=null===(u=(q=l).constructor)||void 0===u?void 0:u.call(q))&&void 0!==n?n:Object.create(null);c.push([Object.keys(l),Object.values(l)]);b.push(a[g])}else a[g]=l}}while(0<c.length);return e}},{key:"merge",value:function(a,b){var c,e;if(d.isEmpty(a))return b;if(d.isEmpty(b))return a;var f=null!==(c=null===(e=b.constructor)||void 0===e?void 0:e.call(b))&&
void 0!==c?c:Object.create(null);c=[f];b=[[[Object.keys(a),Object.values(a)],[Object.keys(b),Object.values(b)]]];do{a=c.shift();e=b.shift();var g=J(e);var k=J(g[0]);e=k[0];k=k[1];var h=J(g[1]);g=h[0];var l=h[1];g=R(new Set(g.concat(e)));for(var n=0;n<g.length;n++){var u;var q=[g[n],l[n]];h=q[0];var r=q[1];q=k[e.indexOf(h)];if(((u=void 0===q)||d.isCollection(q))&&d.isCollection(r)){var v,t,w=[];a[h]=null!==(v=null===(t=u?r.constructor:q.constructor)||void 0===t?void 0:t())&&void 0!==v?v:Object.create(null);
w[1]=[Object.keys(r),Object.values(r)];w[0]=u?[[],[]]:[Object.keys(q),Object.values(q)];c.push(a[h]);b.push(w)}else!d.isCollection(q)&&d.isCollection(r)?a[h]=q:Object.defineProperty(a,h,{writable:!0,enumerable:!0,value:u?r:q})}}while(0<b.length);return f}}]);return d}();Object.defineProperty(T._assistant,"object",{value:Y});
var Ba=function(){function d(){K(this,d)}O(d,null,[{key:"multiply",value:function(a,b){var c,e;a=a.toString();b=b.toString();var f=null!==(c=null===(e=b.split(".")[1])||void 0===e?void 0:e.length)&&void 0!==c?c:0;c=Math.pow(10,f);return Number(a.replace(".",""))*Number(b.replace(".",""))/c}},{key:"divide",value:function(a,b){var c,e,f,g;var k=Math.pow(10,Math.max(null!==(c=null===(e=a.toString().split(".")[1])||void 0===e?void 0:e.length)&&void 0!==c?c:0,null!==(f=null===(g=b.toString().split(".")[1])||
void 0===g?void 0:g.length)&&void 0!==f?f:0));return a*k/(b*k)}},{key:"getMedian",value:function(a){a=a.map(function(c){return c}).sort(function(c,e){return c-e});if(1===a.length%2){var b=window.parseInt(a.length/2);a=a[b]}else b=window.parseInt(a.length/2),a=(a[b-1]+a[b])/2;return a}},{key:"getMode",value:function(a){var b,c;var e=0;var f=[];var g=new Map;a.forEach(function(k){var h;c=null!==(h=g.get(k))&&void 0!==h?h:0;g.set(k,c+1)});e=(b=Math).max.apply(b,R(g.values()));g.forEach(function(k,h){k===
e&&f.push(h)});return f}},{key:"isFloat",value:function(a){var b;if(!Number.isFinite(b=window.parseFloat(a))||Math.floor(b)==b)return!1;if(a.endsWith("%")){if(100<b)return!1}else if(a.endsWith("\u2030")){if(1E3<b)return!1}else return!1;return!0}},{key:"getMinLegalSize",value:function(a,b){var c=[];var e=a[0]/a[1];var f=1>e?0:1;var g=Number(!f);a[f]<b[f]?(c[f]=b[f],c[g]=0===f?b[f]/e:b[f]*e):c=a;return c}},{key:"getMaxLegalSize",value:function(a,b){if(!a||!b||a[0]<=b[0]&&a[1]<=b[1])return a;var c=[];
var e=a[0]/a[1];var f=1<=b[0]/b[1]?1:0;var g=Number(!f);a[f]>b[f]?(c[f]=b[f],c[g]=0===f?b[f]/e:b[f]*e):c=a;return c}},{key:"intervalJudgment",value:function(a,b){b=b.replace(/ /g,"").toLowerCase();var c={"(":">",")":"<","[":">=","]":"<="};var e=b[0];var f=b.slice(-1);var g=Object.keys(c);b=b.slice(1,-1).split(",");b[0]=Number(b[0]);b[1]=Number(b[1]);return g.includes(e)||g.includes(f)?(new Function('"use strict"; return '+(a+c[e]+b[0]+"&&"+a+c[f]+b[1])))():!1}},{key:"insideRect",value:function(a,
b){var c=b[0];b=b[1];return a[0]<c[0]||a[1]<c[1]||a[0]>b[0]||a[1]>b[1]?!1:!0}}]);return d}();window.math&&(Ba=Object.assign(Ba,window.math));Object.defineProperty(T._assistant,"number",{value:Ba});
var Ca=function(){function d(){K(this,d)}O(d,null,[{key:"base64Encode",value:function(a){return window.btoa(window.unescape(window.encodeURIComponent(a)))}},{key:"base64Decode",value:function(a){return window.decodeURIComponent(window.escape(window.atob(a)))}},{key:"ucfirst",value:function(a){return a[0].toUpperCase()+a.substring(1)}},{key:"replace",value:function(a,b,c){var e,f,g,k,h,l=3<arguments.length&&void 0!==arguments[3]?arguments[3]:0,n,u;b=Array.isArray(b)?b:[b];c=Array.isArray(c)?c:[c];
Array.isArray(a)?n=!0:(a=[a],n=!1);if(1<c.length&&b.length!==c.length)throw Error("The number of search strings does not match the number of replacement strings.");var q=[];for(h=0;h<a.length;h++){q[h]="";var r=a[h];for(u=e=g=k=0;g<b.length;g++,k+=1<c.length?1:0){var v=[];var t=b[g];var w=c[k];for(f=0;0<=f&&(0===l||0<l&&u<l);)f=r.indexOf(t,0===f&&0===u?0:f+1),u+=0<=f?1:0,v.push(f);-1!==v[v.length-1]&&v.push(-1);for(var y=0;0<v.length;y++)f=v.shift(),q[h]+=0<=f?r.substring(e,f)+w:r.substring(e),e=
f+t.length;e=0;r=q[h];q[h]=""}q[h]=r}return n?q:q.shift()}},{key:"colorConvert",value:function(a){a=a.toLowerCase();var b=Error("Not a legal color.");if(0===a.indexOf("#")){var c="rgba(";a=a.substring(1);3===a.length&&(a=a.split("").reduce(function(f,g){return f+g+g},""));if(6===a.length)for(b=0;3>b;b++)c+=Number("0x"+a[2*b]+a[2*b+1])+", ";else throw b;c+="255)"}else if(0===a.indexOf("rgb")){c="#";a=a.replace(/(rgb\(|rgba\(|\)| )/g,"").split(",");for(var e=0;3>e;e++)b=Number(a[e]).toString(16),c+=
1===b.length?b+b:b}else throw b;return c}}]);return d}();Object.defineProperty(T._assistant,"string",{value:Ca});
...
a&&(b[1]+=c.offsetHeight))});return b}},{key:"maxZIndex",value:function(a){var b;a?b=d.a(a):b=Array.from(document.all);return parseInt(b.reduce(function(c,e){e=getComputedStyle(e,null).zIndex;return Math.max(c,Number.isInteger(e)?0:e)},0))}},{key:"objectToNode",value:function(a){var b={},c;for(c in a){var e=document.createElement(a[c].nodeType);if("undefined"!=typeof a[c].nodeType){for(var f in a[c])if("nodeType"!=f)if("innerhtml"==f.toLocaleLowerCase()){var g=d.objectToNode(a[c][f]),k;for(k in g)e.insertAdjacentElement("beforeend",
g[k])}else"innertext"==f.toLocaleLowerCase()?e.insertAdjacentText("beforeend",a[c][f]):e.setAttribute(f,a[c][f]);b[c]=e}}return b}},{key:"launchFullscreen",value:function(a){return a.requestFullscreen(1<arguments.length&&void 0!==arguments[1]?arguments[1]:{navigationUI:"show"})}},{key:"exitFullscreen",value:function(){document.exitFullscreen()}},{key:"getFullscreenNode",value:function(){return document.fullscreenElement}},{key:"createScript",value:function(a){var b=document.createElement("script");
"src type async defer charset innerHTML".split(" ").forEach(function(c){a[c]&&(b[c]=a[c])});return b}}]);return d}();Object.defineProperty(T._assistant,"element",{value:Da});
...
Math.PI)),1/(2*Math.PI*e.square)],f.set(b,e));switch(c){case 1:var g=Math.exp(-(a*a)/(2*e.square));break;case 2:g=Math.exp(-(Math.pow(a[0],2)+Math.pow(a[1],2))/(2*e.square))}return e.multiplier[c-1]*g}}]);return d}();Object.defineProperty(T._assistant,"formula",{value:Ea});
var Fa=function(){function d(){K(this,d)}O(d,null,[{key:"getStorage",value:function(a){var b=1<arguments.length&&void 0!==arguments[1]?arguments[1]:[];if(!d._achieve[a])throw Error("The specified storage ".concat(a," was not found."));return ta(d._achieve[a],R(b))}}]);return d}();P(Fa,"_achieve",Object.create(null));Object.defineProperty(T._assistant,"storage",{value:Fa});
...
1<arguments.length&&void 0!==arguments[1]?arguments[1]:0,c=2<arguments.length&&void 0!==arguments[2]?arguments[2]:0,e=3<arguments.length?arguments[3]:void 0,f=4<arguments.length?arguments[4]:void 0,g=5<arguments.length&&void 0!==arguments[5]?arguments[5]:1,k=6<arguments.length&&void 0!==arguments[6]?arguments[6]:"white",h=7<arguments.length&&void 0!==arguments[7]?arguments[7]:!1;a.save();a.lineWidth=g;Array.isArray(h)?(a.strokeStyle=k,a.setLineDash(h),a.strokeRect(b,c,e,f)):(a.fillStyle=k,a.fillRect(b,
c,e,f));a.restore()}},{key:"drawLBorder",value:function(a){var b=1<arguments.length&&void 0!==arguments[1]?arguments[1]:0,c=2<arguments.length&&void 0!==arguments[2]?arguments[2]:0,e=3<arguments.length?arguments[3]:void 0,f=4<arguments.length?arguments[4]:void 0,g=5<arguments.length&&void 0!==arguments[5]?arguments[5]:25,k=6<arguments.length&&void 0!==arguments[6]?arguments[6]:5,h=7<arguments.length&&void 0!==arguments[7]?arguments[7]:"#0eb0f1",l=8<arguments.length&&void 0!==arguments[8]?arguments[8]:
!1;a.save();Array.isArray(l)?a.strokeStyle=h:(a.fillStyle=h,a.fillRect(b,c,g,k),a.fillRect(b,c,k,g),a.fillRect(b+e,c,-g,k),a.fillRect(b+e,c,-k,g),a.fillRect(b+e,c+f,-g,-k),a.fillRect(b+e,c+f,-k,-g),a.fillRect(b,c+f,g,-k),a.fillRect(b,c+f,k,-g));a.restore()}},{key:"drawGrid",value:function(a){var b=1<arguments.length&&void 0!==arguments[1]?arguments[1]:0,c=2<arguments.length&&void 0!==arguments[2]?arguments[2]:0,e=3<arguments.length?arguments[3]:void 0,f=4<arguments.length?arguments[4]:void 0,g=5<
arguments.length&&void 0!==arguments[5]?arguments[5]:1,k=6<arguments.length&&void 0!==arguments[6]?arguments[6]:"black",h=7<arguments.length&&void 0!==arguments[7]?arguments[7]:"quarter",l=8<arguments.length&&void 0!==arguments[8]?arguments[8]:!1;if(d["drawGrid"+Ca.ucfirst(h)]instanceof Function)d["drawGrid"+Ca.ucfirst(h)](a,b,c,null!==e&&void 0!==e?e:a.canvas.width,null!==f&&void 0!==f?f:a.canvas.height,g,k,l);else throw Error(h+" grid not detected");}},{key:"drawGridQuarter",value:function(a){var b=
1<arguments.length&&void 0!==arguments[1]?arguments[1]:0,c=2<arguments.length&&void 0!==arguments[2]?arguments[2]:0,e=3<arguments.length?arguments[3]:void 0,f=4<arguments.length?arguments[4]:void 0,g=5<arguments.length&&void 0!==arguments[5]?arguments[5]:1,k=6<arguments.length&&void 0!==arguments[6]?arguments[6]:"black",h=7<arguments.length&&void 0!==arguments[7]?arguments[7]:!1;var l=[Ba.divide(e,4),Ba.divide(f,4)];a.save();a.beginPath();a.lineWidth=g;a.strokeStyle=k;Array.isArray(h)&&a.setLineDash(h);
for(g=1;4>g;g++)a.moveTo(l[0]*g+b,c),a.lineTo(l[0]*g+b,c+f),a.moveTo(b,l[1]*g+c),a.lineTo(b+e,l[1]*g+c);a.stroke();a.restore()}},{key:"layerMerge",value:function(a,b,c,e,f){var g=5<arguments.length&&void 0!==arguments[5]?arguments[5]:"source-over",k;(k=Z.get("mergeCas",d))||(k=new OffscreenCanvas(a.canvas.width,a.canvas.height),Z.set("mergeCas",k,d));var h=k.getContext("2d");h.save();h.drawImage.apply(h,[b].concat(R(c)));h.globalCompositeOperation=g;h.drawImage.apply(h,[e].concat(R(f)));a.clearRect(0,
0,a.canvas.width,a.canvas.height);a.drawImage(k,0,0);h.restore();h.clearRect(0,0,k.width,k.height)}},{key:"download",value:function(a){var b=1<arguments.length&&void 0!==arguments[1]?arguments[1]:"canvas",c=2<arguments.length?arguments[2]:void 0;if(Z.has("downloadNode",d))var e=Z.get("downloadNode",d);else e=document.createElement("a"),Z.set("downloadNode",e,d);e.download=b;e.href=a.toDataURL(c);e.click()}}]);return d}();Object.defineProperty(T._assistant,"canvas",{value:Ga});
var Ha=function(){function d(){K(this,d)}O(d,null,[{key:"getImagedata",value:function(a){if(a instanceof Image){var b=document.createElement("canvas");var c=b.getContext("2d");c.drawImage(a,0,0);a=c.getImageData(0,0,b.width,b.height)}else if(!(a instanceof ImageData))throw Error("can not parse image");return a}},{key:"grayscale",value:function(a){try{var b=d.getImagedata(a);var c=b.width*b.height*4;var e=new Uint8ClampedArray(b.data.length);for(a=0;a<c;a+=4){var f=b.data[a];var g=b.data[a+1];var k=
b.data[a+2];var h=b.data[a+3];var l=.299*f+.587*g+.114*k;e[a]=l;e[a+1]=l;e[a+2]=l;e[a+3]=h}}catch(n){throw n;}return new ImageData(e,b.width,b.height)}},{key:"gaussianBlur",value:function(a){var b=1<arguments.length&&void 0!==arguments[1]?arguments[1]:3,c=2<arguments.length&&void 0!==arguments[2]?arguments[2]:1,e,f,g,k,h,l,n;try{var u=d.getImagedata(a);var q=u.width;var r=u.height;var v=0;(f=Z.get("gaussianMask",d))||(f=new Map,Z.set("gaussianMask",f,d));if(!(e=f.get("".concat(b,",").concat(c)))){e=
[];for(n=-b;n<=b;n++){var t=Ea.getDistribution(n,c,1);e.push(t);v+=t}for(t=0;t<e.length;t++)e[t]/=v;f.set("".concat(b,",").concat(c),e)}var w=new Uint8ClampedArray(u.data.length);for(l=0;l<r;l++)for(h=0;h<q;h++){var y=g=k=v=0;var p=4*(l*q+h);for(c=-b;c<=b;c++){var B=h+c;n=c+b;if(0<=B&&B<q){var I=4*(l*q+B);y+=u.data[I]*e[n];g+=u.data[I+1]*e[n];k+=u.data[I+2]*e[n];v+=e[n]}}w[p]=y/v;w[p+1]=g/v;w[p+2]=k/v;w[p+3]=u.data[p+3]}for(h=0;h<q;h++)for(l=0;l<r;l++){y=g=k=v=0;p=4*(l*q+h);for(u=-b;u<=b;u++)B=l+
u,n=u+b,0<=B&&B<r&&(I=4*(B*q+h),y+=w[I]*e[n],g+=w[I+1]*e[n],k+=w[I+2]*e[n],v+=e[n]);w[p]=y/v;w[p+1]=g/v;w[p+2]=k/v}}catch(Q){throw Q;}return new ImageData(w,q,r)}},{key:"mirror",value:function(a){var b=1<arguments.length&&void 0!==arguments[1]?arguments[1]:1,c,e;try{var f=d.getImagedata(a);var g=f.width;var k=f.height;var h=new Uint8ClampedArray(f.data.length);for(e=0;e<k;e++)for(c=0;c<g;c++){var l=4*(e*g+c);if(0==b)var n=4*(e*g+g-c);else if(1==b)n=4*((k-e)*g+c);else throw Error("not give axis");
h[l]=f.data[n];h[l+1]=f.data[n+1];h[l+2]=f.data[n+2];h[l+3]=f.data[n+3];h[n]=f.data[l];h[n+1]=f.data[l+1];h[n+2]=f.data[l+2];h[n+3]=f.data[l+3]}}catch(u){throw u;}return new ImageData(h,g,k)}}]);return d}();P(Ha,"__gaussianMask",{});Object.defineProperty(T._assistant,"canvasFilter",{value:Ha});
var Ia=function(){function d(){K(this,d)}O(d,null,[{key:"loadFailedFade",value:function(a,b){var c,e,f,g;if(!(a instanceof CanvasRenderingContext2D))throw Error('Requires a value of type "CanvasRenderingContext2D"');Y.isEmpty(b)&&(b=Object.create(null));var k="animation-loadFailedFade-"+Date.now()+"-"+performance.now()+(b.sign?"-"+b.sign:"");b=Y.o(b,{duration:4,speed:null,icon:{size:72,"char":["!","?"],color:"rgba(220, 53, 69)",font:"bold 72px Microsoft YaHei, serif"},text:{size:16,color:"black",
...
f[u].getContext("2d");b.icon.text=b.icon["char"][u];Ga.drawText(q,b.icon)}c.set(h,f)}(g=c.get(l))||(g=new OffscreenCanvas(b.text.size*b.text.text.length,2*b.text.size),h=g.getContext("2d"),Ga.drawText(h,b.text),c.set(l,g));(l=c.get(n))||(l=h=2*(b.round.radius+b.round.borderWidth),l=new OffscreenCanvas(l,h),h=l.getContext("2d"),Ga.drawRound(h,b.round),c.set(n,l));var r=1;var v=e=0;var t=[a.canvas.width/2,a.canvas.height/2];c=[l.width/2,(l.height+g.height)/2];n=[g.width/2,(l.height-g.height)/2];var w=
1/(b.duration/f.length/2*1E3/(1E3/60));var y=function(){var p=w*r,B=Number(a.canvas.getAttribute(k)),I=[f[v].width/2,(f[v].height+g.height)/2];void 0!==B&&0!==B&&(a.clearRect(t[0]-I[0],t[1]-I[1],f[v].width,f[v].height),1<e+p?(e=1,r=-r):0>e+p?(e=0,r=-r,v=v+1<f.length?v+1:0):e+=p,a.globalAlpha=e,a.drawImage(f[v],t[0]-I[0],t[1]-I[1]),window.requestAnimationFrame(y))};a.globalAlpha=1;a.drawImage(l,t[0]-c[0],t[1]-c[1]);a.drawImage(g,t[0]-n[0],t[1]+n[1]);a.canvas.setAttribute(k,1);window.requestAnimationFrame(y);
return k}}]);return d}();Object.defineProperty(T._assistant,"canvasAnimation",{value:Ia});
var Ja=function(d){function a(){K(this,a);return b.apply(this,arguments)}G(a,d);var b=H(a);O(a,[{key:"initOption",value:function(c){E(F(a.prototype),"initOption",this).call(this,c);this.option.layer=T._assistant.object.merge(this.option.layer,T._option.page)}},{key:"linkageOption",value:function(){E(F(a.prototype),"linkageOption",this).call(this);null!==this.option.layer.src&&null!==this.option.layer.srcdoc&&(this.option.layer.srcdoc=null)}},{key:"initStruct",value:function(){E(F(a.prototype),"initStruct",
this).call(this);var c=this.variable.struct._build.container;var e=this.variable.struct._backup.title=T._struct.title;var f=this.variable.struct._backup.action=T._struct.action;var g=this.variable.struct._backup.content=T._struct.content;var k=this.variable.struct._backup.content_page=T._struct.content_page;var h=this.variable.struct._backup.action_button=T._struct.action_button;f.innerHTML.push(h.minimize,h.expand,h.close);e.innerHTML.push(f);!1!==this.option.title&&c.innerHTML.push(e);g.innerHTML.push(k);
c.innerHTML.push(g);this.option.resize.enable&&(k=this.variable.struct._backup.resize_box=T._struct.resize_box,c.innerHTML.push(k));this.option.progress.enable&&(k=this.variable.struct._backup.progress_bar=T._struct.progress_bar,c.innerHTML.push(k))}},{key:"initNode",value:function(){var c=this;E(F(a.prototype),"initNode",this).call(this);var e=this.variable.nodes.container.querySelector(".modal-layer-page-content");Object.keys(this.option.layer).forEach(function(f){T._assistant.object.isEmpty(c.option.layer[f])||
("name"===f?e.setAttribute("name",c.option.layer.name+c.option.index):e.setAttribute(f,c.option.layer[f]))})}},{key:"resize",value:function(){var c=0;var e=this.variable.nodes.container;var f=e.children;var g=e.querySelector("iframe[name="+this.option.layer.name+this.option.index+"]");g.style.cssText="width: ".concat(this.option.layer.area[0],"px; height: ").concat(this.option.layer.area[1],"px;");g=this.option.layer.area[0]+2*g.parentNode.offsetLeft;for(var k=0;k<f.length;k++)c="absolute"==getComputedStyle(f[k],
null).position?c:Math.max(T._assistant.element.getNodeHeight(f[k]),c);e.style.cssText+="width: ".concat(g,"px; height: ").concat(c,"px;");this.variable.defaultRect.width=g;this.variable.defaultRect.height=c;this.variable.defaultArea=[g,c]}}]);return a}(T);T._achieve.set("page",Ja);
var Ka=function(d){function a(){K(this,a);return b.apply(this,arguments)}G(a,d);var b=H(a);O(a,[{key:"initStruct",value:function(){E(F(a.prototype),"initStruct",this).call(this);var c=this.variable.struct._build.container;var e=this.variable.struct._backup.title=T._struct.title;var f=this.variable.struct._backup.action=T._struct.action;var g=this.variable.struct._backup.content=T._struct.content;var k=this.variable.struct._backup.interaction=T._struct.interaction;var h=this.variable.struct._backup.action_button=
T._struct.action_button;var l=this.variable.struct._backup.interaction_button=T._struct.interaction_button;f.innerHTML.push(h.close);e.innerHTML.push(f);!1!==this.option.title&&c.innerHTML.push(e);c.innerHTML.push(g);this.option.resize.enable&&(f=this.variable.struct._backup.resize_box=T._struct.resize_box,c.innerHTML.push(f));this.option.progress.enable&&(f=this.variable.struct._backup.progress_bar=T._struct.progress_bar,c.innerHTML.push(f));k.innerHTML.push(l.ok);c.innerHTML.push(k)}},{key:"initNode",
value:function(){E(F(a.prototype),"initNode",this).call(this);var c=this.variable.nodes.container.querySelector(".modal-layer-content");if(Array.isArray(this.option.content.value)){var e=T._assistant.element.objectToNode(this.option.content.value);Object.keys(e).forEach(function(f){c.appendChild(e[f])})}else c.innerHTML=this.option.content.value}}]);return a}(T);T._achieve.set("alert",Ka);
var Ma=function(d){function a(){K(this,a);return b.apply(this,arguments)}G(a,d);var b=H(a);O(a,[{key:"initOption",value:function(c){var e=this,f;E(F(a.prototype),"initOption",this).call(this,c);this.option.layer=T._assistant.object.merge(this.option.layer,T._option.image);var g=[window.innerWidth,window.innerHeight];Object.values(this.option.layer.sizeRange).forEach(function(k){k.forEach(function(h,l){if((""+h).endsWith("%"))f=100;else if((""+h).endsWith("\u2030"))f=1E3;else if((""+h).includes("0."))f=
1;else return h;k[l]=g[l]*window.parseFloat(h)/f})});this.option.layer.sizeRange.min[0]>this.option.layer.sizeRange.max[0]&&(this.option.layer.sizeRange.min[0]=this.option.layer.sizeRange.max[0]);this.option.layer.sizeRange.min[1]>this.option.layer.sizeRange.max[1]&&(this.option.layer.sizeRange.min[1]=this.option.layer.sizeRange.max[1]);Object.keys(this.option.layer.toolbar.config).forEach(function(k,h){h=e.option.layer.toolbar.config[k];"boolean"==typeof h&&(e.option.layer.toolbar.config[k]={enable:h,
title:T._option.image.toolbar.config[k].title,icon:T._option.image.toolbar.config[k].icon});T._assistant.object.isOnlyObject(h.config)?Object.keys(h.config).forEach(function(l,n){n=h.config[l];"boolean"==typeof n&&(e.option.layer.toolbar.config[k].config[l]={enable:n,title:T._option.image.toolbar.config[k].config[l].title,icon:T._option.image.toolbar.config[k].config[l].icon})}):T._option.image.toolbar.config[k].config&&(e.option.layer.toolbar.config[k].config=JSON.parse(JSON.stringify(T._option.image.toolbar.config[k].config)))})}},
{key:"compatibleOption",value:function(c){var e,f;E(F(a.prototype),"compatibleOption",this).call(this,c);var g=T._assistant.object.get(c,"layer.image");g instanceof FileList&&(c.layer.image=Object.values(g));Array.isArray(c.layer.image)||(c.layer.image=[c.layer.image]);var k=null!==(e=T._assistant.object.get(c,"layer.toolbar.config"))&&void 0!==e?e:[];Object.keys(k).forEach(function(l){k[l]="boolean"===typeof k[l]?{enable:k[l]}:k[l]});var h=null!==(f=T._assistant.object.get(c,"layer.toolbar.config.filter.config"))&&
...
this).call(this);var e=this.variable.struct._build.container;var f=this.variable.struct._backup.title=T._struct.title;var g=this.variable.struct._backup.action=T._struct.action;var k=this.variable.struct._backup.toolbar=T._struct.toolbar;var h=this.variable.struct._backup.tools=T._struct.image_tools;var l=this.variable.struct._backup.content=T._struct.content;var n=this.variable.struct._backup.action_button=T._struct.action_button;var u=this.variable.struct._backup.content_image=T._struct.content_image;
...
this.option.layer.toolbar.enable&&e.innerHTML.push(k);l.innerHTML.push(u);e.innerHTML.push(l);this.option.resize.enable&&(g=this.variable.struct._backup.resize_box=T._struct.resize_box,e.innerHTML.push(g));this.option.progress.enable&&(g=this.variable.struct._backup.progress_bar=T._struct.progress_bar,e.innerHTML.push(g))}},{key:"initNode",value:function(){var c=this;E(F(a.prototype),"initNode",this).call(this);var e=this.variable.nodes.container.querySelector(".modal-layer-toolbar");this.option.layer.toolbar.enable&&
Object.keys(this.option.layer.toolbar.config).forEach(function(f,g){g=c.option.layer.toolbar.config[f];if(g.enable){var k;var h=e.querySelector('.modal-layer-toolbar-item[tool-type="'+f+'"]');var l=h.querySelector(".modal-layer-toolbar-item-icon");h.setAttribute("title",g.title);(k=l.classList).add.apply(k,R(g.icon.split(" ")));g.config instanceof Object&&Object.entries(g.config).forEach(function(n,u){u=n[0];n=n[1];if(n.enable){var q=h.querySelector(".modal-layer-toolbar-item-child-list");u=h.querySelector(".modal-layer-toolbar-"+
f+"-icon["+f+'-type="'+u+'"]');q.setAttribute("title",n.title);n.icon?u.classList.add(n.icon):u.innerText=n.textIcon}})}});this.variable.image.finish=this.load().then(function(f){return c.loaded(f)})["catch"](function(){return c.failed()})}},{key:"bindEvent",value:function(){var c=this;E(F(a.prototype),"bindEvent",this).call(this);var e={once:!1,capture:!1,passive:!1,mozSystemGroup:!1};var f=this.variable.nodes.container;var g=T._assistant.object.getKeyByValue(T._enum.LOAD_STATUS,T._enum.LOAD_STATUS.FAILED);
this.variable.eventSymbol.imageReload=T._assistant.event.add(f,"click",'.modal-layer-image-canvas[load-status="'+g+'"]',this.reload,this,null,e);Object.keys(this.event.imageTools).forEach(function(k){c.event.imageTools[k]&&c.event.imageTools[k]instanceof Function&&(c.variable.eventSymbol["imageTool".concat(k)]=T._assistant.event.add(f,"click",'.modal-layer-toolbar-item[tool-type="'.concat(k,'"]'),c.event.imageTools[k],c,null,e))})}},{key:"resize",value:function(){var c;var e=this.variable.nodes.container;
var f=e.querySelector(".modal-layer-content");var g=f.querySelector(".modal-layer-image-canvas").getBoundingClientRect();var k=e.querySelector(".modal-layer-toolbar");var h=k.getBoundingClientRect().height;var l=window.getComputedStyle(f,null);var n=T._assistant.element.getBeforeElementHeight(f);f=f.offsetTop-n;n+=this.option.content.fullContainer?0:2*f;this.option.layer.size?c=R(this.option.layer.size):this.variable.image.status!==T._enum.LOAD_STATUS.LOADING?c=[g.width,g.height]:c=R(this.option.layer.sizeRange.min);
c[0]+=parseFloat(l.marginLeft)+parseFloat(l.marginRight);c[1]+=n;e.style.width=c[0]+"px";this.option.layer.toolbar.enable&&(g=k.getBoundingClientRect().height,c[1]=c[1]-h+g);e.style.height=c[1]+"px";this.variable.defaultArea=c;this.variable.defaultRect.width=c[0];this.variable.defaultRect.height=c[1];!this.option.drag.overflow&&T._assistant.element.isOverflow(e,this.option.window)&&this.positioning()}},{key:"load",value:function(){var c=this,e=this.variable.nodes.container.querySelector(".modal-layer-image-canvas");
this.variable.image.status=T._enum.LOAD_STATUS.LOADING;e.setAttribute("load-status",T._assistant.object.getKeyByValue(T._enum.LOAD_STATUS,T._enum.LOAD_STATUS.LOADING));this.variable.image.fadeAttr&&e.removeAttribute(this.variable.image.fadeAttr);this.variable.image.layer instanceof La?this.variable.image.layer.show():this.variable.image.layer=T.loading({mask:!1,popupTime:0,layer:{icon:1,duration:1,color:"deepskyblue"},window:this.variable.nodes.container.querySelector(".modal-layer-content")},function(f){throw f;
...
this.load().then(function(e){return c.loaded(e)})["catch"](function(){return c.failed()})["finally"](function(){return c.resize()})}},{key:"loaded",value:function(c){var e=this;var f=this.variable.nodes.container.querySelector(".modal-layer-image-canvas");this.variable.image.status=T._enum.LOAD_STATUS.LOADED;this.variable.image["default"].size=this.option.layer.size?this.option.layer.size:c.naturalWidth>this.option.layer.sizeRange.max[0]||c.naturalHeight>this.option.layer.sizeRange.max[1]?T._assistant.number.getMaxLegalSize([c.naturalWidth,
...
k;e.variable.image.layer&&e.variable.image.layer instanceof La&&e.variable.image.layer.hide();(g=f.getContext("2d")).drawImage.apply(g,[c,0,0,c.width,c.height,0,0].concat(R(e.variable.image["default"].size)));e.variable.image["default"].imageData=(k=f.getContext("2d")).getImageData.apply(k,[0,0].concat(R(e.variable.image["default"].size)))})}},{key:"failed",value:function(){var c,e;var f=this.variable.nodes.container.querySelector(".modal-layer-image-canvas");this.variable.image.status=T._enum.LOAD_STATUS.FAILED;
f.setAttribute("load-status",T._assistant.object.getKeyByValue(T._enum.LOAD_STATUS,T._enum.LOAD_STATUS.FAILED));this.variable.image.reload<this.option.layer.image.length?e={duration:4,sign:"load-failed",icon:{size:72,"char":"!?",color:"rgba(220, 53, 69)",font:"bold 72px Microsoft YaHei, serif"},round:{step:[4],radius:50,borderWidth:5,borderColor:"rgb(230, 230, 230)"},text:{color:"rgba(220, 53, 69)",text:"\u56fe\u7247\u52a0\u8f7d\u5931\u8d25, \u8bf7\u70b9\u51fb\u91cd\u8bd5",font:"lighter 16px Microsoft YaHei, serif"}}:
e={duration:4,sign:"finally-load-failed",icon:{size:80,"char":"\u00d7",font:"bold 80px Microsoft YaHei, serif"},round:{step:[5],radius:50,borderWidth:5,borderColor:"rgb(230, 230, 230)"},text:{color:"rgba(220, 53, 69)",text:"\u56fe\u7247\u52a0\u8f7d\u5931\u8d25, \u8bf7\u8054\u7cfb\u7ba1\u7406\u5458",font:"lighter 16px Microsoft YaHei, serif"}};this.variable.image.fadeAttr=T._assistant.canvasAnimation.loadFailedFade(f.getContext("2d"),e);(null===(c=this.variable.image.link)||void 0===c?0:c.startsWith("blob:"))&&
URL.revokeObjectURL(this.variable.image.link);this.variable.image.link=null;this.variable.image.layer instanceof La&&this.variable.image.layer.hide()}},{key:"removeAllEvent",value:function(){var c=this,e=this.variable.nodes.container;E(F(a.prototype),"removeAllEvent",this).call(this);Object.keys(this.event.imageTools).forEach(function(f){c.event.imageTools[f]&&c.event.imageTools[f]instanceof Function&&e.removeEventListener("click",c.event.imageTools[f])})}},{key:"crop",value:function(){var c=this,
e,f;var g=!0;var k=null;var h=[];var l=T._assistant.number.divide(5,2);h[2]=T._assistant.number.multiply(5,2);h[4]=T._assistant.number.multiply(5,4);h[6]=T._assistant.number.multiply(5,6);var n=this.variable.nodes.container.querySelector(".modal-layer-image-canvas");var u=n.width;var q=n.height;var r=T._assistant.number.floor(.1*u);var v=T._assistant.number.floor(.1*q);var t=n.cloneNode();var w=t.getContext("2d");t.width=window.innerWidth;t.height=window.innerHeight;t.style="display: block; position: fixed; top: 0px; bottom: 0px; left: 0px; right: 0px; visibility: visible; opacity: 1; border: 0px; margin: 0px; z-index: "+
T._assistant.element.maxZIndex()+";";var y=[T._assistant.number.chain(t.width).subtract(u).divide(2).round().done(),T._assistant.number.chain(t.height).subtract(q).divide(2).round().done()];var p=[].concat(R(y),[u,q]);var B=function(){var x;w.save();w.clearRect(0,0,t.width,t.height);w.fillStyle="rgba(0, 0, 0, 0.4)";w.fillRect(0,0,t.width,t.height);w.globalCompositeOperation="destination-out";w.fillStyle="white";w.fillRect.apply(w,R(p));w.globalCompositeOperation="source-over";(x=T._assistant.canvas).drawGrid.apply(x,
[w].concat(R(p),[2,"white","quarter"]));T._assistant.canvas.drawRect(w,p[0]-l,p[1]-l,p[2]+5,p[3]+5,5,"white",[0]);T._assistant.canvas.drawLBorder(w,p[0]-h[2],p[1]-h[2],p[2]+h[4],p[3]+h[4],h[6],5,"white");w.globalCompositeOperation="destination-over";w.drawImage.apply(w,[n].concat(R(y)));w.restore();g?k=window.requestAnimationFrame(B):window.cancelAnimationFrame(k)};var I=function(){document.removeEventListener("keyup",Q);t.removeEventListener("mousemove",L);t.removeEventListener("dbclick",X);g=!1;
t.remove()};var Q=function(x){var A;x=null!==(A=x)&&void 0!==A?A:window.event;switch(x.code){case "Enter":X();x.preventDefault();break;case "Escape":c.show(),I(),x.preventDefault()}};var X=function(x){var A;I();x=null!==(A=x)&&void 0!==A?A:window.event;x=new OffscreenCanvas(n.width,n.height);x.getContext("2d").drawImage(n,0,0);n.width=p[2];n.height=p[3];n.getContext("2d").drawImage(x,p[0]-y[0],p[1]-y[1],p[2],p[3],0,0,n.width,n.height);c.show().then(function(){return c.resize()})};var L=function(x){var A;
x=null!==(A=x)&&void 0!==A?A:window.event;if(e&&1===x.buttons)if("drag"===e)p[0]+x.movementX>y[0]&&p[0]+p[2]+x.movementX<y[0]+u&&(p[0]+=x.movementX),p[1]+x.movementY>y[1]&&p[1]+p[3]+x.movementY<y[1]+q&&(p[1]+=x.movementY);else{if("resize"===e){A=R(p);f.includes(T._enum.DIRECTION.WEST)&&(p[0]+=x.movementX,p[2]-=x.movementX);f.includes(T._enum.DIRECTION.EAST)&&(p[2]+=x.movementX);f.includes(T._enum.DIRECTION.NORTH)&&(p[1]+=x.movementY,p[3]-=x.movementY);f.includes(T._enum.DIRECTION.SOUTH)&&(p[3]+=x.movementY);
if(p[0]<y[0]||p[0]+p[2]>y[0]+u)p[0]=A[0],p[2]=A[2];if(p[1]<y[1]||p[1]+p[3]>y[1]+q)p[1]=A[1],p[3]=A[3];p[2]<r&&(p[2]=A[2],p[0]+p[2]>y[0]+u&&(p[0]=y[0]+u-p[2]));p[3]<v&&(p[3]=A[3],p[1]+p[3]>y[1]+q&&(p[1]=y[1]+q-p[3]))}}else{x=[x.x,x.y];var M=[p[0]-h[2],p[1]-h[2],p[2]+h[4],p[3]+h[4]];var N=[p[0]-l,p[1]-l,p[2]+5,p[3]+5];x[0]>N[0]&&x[0]<N[0]+N[2]&&x[1]>N[1]&&x[1]<N[1]+N[3]?(A="move",e="drag"):x[0]>M[0]&&x[0]<M[0]+M[2]&&x[1]>M[1]&&x[1]<M[1]+M[3]?(e="resize",A=f="",x[1]>M[1]&&x[1]<N[1]&&(A=f+=T._enum.DIRECTION.NORTH),
x[1]>N[1]+N[3]&&x[1]<M[1]+M[3]&&(A=f+=T._enum.DIRECTION.SOUTH),x[0]>M[0]&&x[0]<N[0]&&(A=f+=T._enum.DIRECTION.WEST),x[0]>N[0]+N[2]&&x[0]<M[0]+M[2]&&(A=f+=T._enum.DIRECTION.EAST),A+="-resize"):(e=null,A="default");t.style.cssText+="cursor: "+A}};this.hide();B();document.addEventListener("keyup",Q);t.addEventListener("mousemove",L);t.addEventListener("dblclick",X);document.body.appendChild(t)}},{key:"spin",value:function(c){var e=this,f,g,k,h;var l=this.variable.nodes.container.querySelector(".modal-layer-image-canvas");
var n=l.getContext("2d");var u=new OffscreenCanvas(l.width,l.height);u.getContext("2d").drawImage(l,0,0,l.width,l.height);this.variable.image.finish.then(function(){var q;c=null!==(q=c)&&void 0!==q?q:e.variable.image.spin.angle;l.style.transform="rotate("+c+"deg)";f=l.getBoundingClientRect();l.style.transform="scale(".concat(e.variable.image.spin.scale,")");e.option.layer.size||e.option.layer.sizeRange.max[0]>=f.width&&e.option.layer.sizeRange.max[1]>=f.height?k=e.variable.image.spin.scale:(h=T._assistant.number.getMaxLegalSize([f.width,
f.height],e.option.layer.sizeRange.max),k=h[0]/f.width);l.width=f.width;l.height=f.height;l.style.transform="scale(".concat(k,")");g=c*Math.PI/180;n.save();n.translate(l.width/2,l.height/2);n.rotate(g);n.drawImage(u,-u.width/2,-u.height/2);n.restore();e.resize()})}},{key:"filter",value:function(c){var e=this,f,g;var k=c.getAttribute("filter-type");var h=this.variable.nodes.container.querySelector(".modal-layer-image-canvas");if(h.getAttribute("load-status")!=T._enum.LOAD_STATUS.FAILED&&k){var l=h.getContext("2d");
...
u.then(function(){return e.variable.image.layer.hide()});T._assistant.worker.close(q)})}null===(f=(g={blur:function(){var v,t;var w=null!==(v=Number(c.getAttribute("data-sigma")))&&void 0!==v?v:1;v=null!==(t=Number(c.getAttribute("data-radius")))&&void 0!==t?t:3;if(T._env.feature.worker){var y;if(T._assistant.canvasFilter.__gaussianMask[["".concat(v,",").concat(w)]])var p=T._assistant.canvasFilter.__gaussianMask[["".concat(v,",").concat(w)]];else{t=0;p=[];for(y=-v;y<=v;y++){var B=T._assistant.formula.getDistribution(y,
w,1);p.push(B);t+=B}for(y=0;y<p.length;y++)p[y]/=t;T._assistant.canvasFilter.__gaussianMask[["".concat(v,",").concat(w)]]=p}T._assistant.worker.get(q).postMessage({sigma:w,radius:v,type:k,gaussianMask:p,buffer:n.data.buffer,size:[h.width,h.height]},[n.data.buffer])}else n=T._assistant.canvasFilter.gaussianBlur(n,v,w),l.putImageData(n,0,0),u.then(function(){return e.variable.image.layer.hide()})},gray:function(){T._env.feature.worker?T._assistant.worker.get(q).postMessage({type:k,buffer:n.data.buffer},
[n.data.buffer]):(n=T._assistant.canvasFilter.grayscale(l.getImageData(0,0,h.width,h.height)),l.putImageData(n,0,0),u.then(function(){return e.variable.image.layer.hide()}))},mirror:function(){var v,t=null!==(v=Number(c.getAttribute("mirror-axis")))&&void 0!==v?v:0;T._env.feature.worker?T._assistant.worker.get(q).postMessage({axis:t,type:k,buffer:n.data.buffer,size:[h.width,h.height]},[n.data.buffer]):(n=T._assistant.canvasFilter.mirror(l.getImageData(0,0,h.width,h.height),t),l.putImageData(n,0,0),
u.then(function(){return e.variable.image.layer.hide()}))}})[k])||void 0===f?void 0:f.call(g)}}},{key:"revert",value:function(){var c=this.variable.nodes.container.querySelector(".modal-layer-image-canvas");var e=c.getContext("2d");this.variable.image.spin.scale=1;c.width=this.variable.image["default"].size[0];c.height=this.variable.image["default"].size[1];c.removeAttribute("style");e.putImageData(this.variable.image["default"].imageData,0,0);this.resize()}},{key:"download",value:function(){var c,
e=this.variable.nodes.container.querySelector(".modal-layer-image-canvas"),f=null!==(c=e.getAttribute("download-filename"))&&void 0!==c?c:this.option.layer.toolbar.config.download.name+Date.now();T._assistant.canvas.download(e,f,this.option.layer.toolbar.config.download.mime)}}]);return a}(T);T._achieve.set("image",Ma);
var Na=function(d){function a(){K(this,a);return b.apply(this,arguments)}G(a,d);var b=H(a);O(a,[{key:"initStruct",value:function(){E(F(a.prototype),"initStruct",this).call(this);this.variable.struct._backup.interaction.innerHTML.push(this.variable.struct._backup.interaction_button.cancel)}}]);return a}(Ka);T._achieve.set("prompt",Na);
var Oa=function(d){function a(){K(this,a);return b.apply(this,arguments)}G(a,d);var b=H(a);O(a,[{key:"initStruct",value:function(){E(F(a.prototype),"initStruct",this).call(this);this.variable.struct._backup.interaction.innerHTML.push(this.variable.struct._backup.interaction_button.no)}}]);return a}(Ka);T._achieve.set("confirm",Oa);
var La=function(d){function a(){K(this,a);return b.apply(this,arguments)}G(a,d);var b=H(a);O(a,[{key:"initOption",value:function(c){E(F(a.prototype),"initOption",this).call(this,c);this.option.layer=T._assistant.object.merge(this.option.layer,T._option.loading);this.option.title=!1;this.option.drag.enable=!1;this.option.resize.enable=!1;this.option.progress.enable=!1;this.option.mask.clickRemove=!1;this.option.content.fullContainer=!0}},{key:"compatibleOption",value:function(c){var e={center:"center",
...
T._struct.content_loading_icon;Number.isInteger(Number(this.option.layer.icon))?f.innerHTML[0]=g[this.option.layer.icon]:f.innerHTML[0]["class"]+=" "+this.option.layer.icon;e.innerHTML.push(f);c.innerHTML.push(e)}},{key:"initAttribute",value:function(){E(F(a.prototype),"initAttribute",this).call(this);var c=this.variable.nodes.container;var e=c.querySelector(".modal-layer-content");var f=e.querySelector(".modal-layer-loading-icon");var g=e.querySelector(".modal-layer-loading-box");c.style.cssText+=
...
"_type",null);P(this,"_record",null);P(this,"_storage",null)}O(d,[{key:"has",value:function(){}},{key:"get",value:function(){}},{key:"set",value:function(){}},{key:"del",value:function(){}},{key:"clear",value:function(){}}]);return d}());Fa&&(Object.defineProperty(Fa._achieve,T._enum.BROWSER_STORAGE.LOCALSTORAGE,{value:Qa}),Object.defineProperty(Fa._achieve,T._enum.BROWSER_STORAGE.SESSIONSTORAGE,{value:Qa}));}(window);
