...
return e}function I(e,b){if(!(e instanceof b))throw new TypeError("Cannot call a class as a function");}function wa(e,b){for(var c=0;c<b.length;c++){var d=b[c];d.enumerable=d.enumerable||!1;d.configurable=!0;"value"in d&&(d.writable=!0);Object.defineProperty(e,d.key,d)}}function J(e,b,c){b&&wa(e.prototype,b);c&&wa(e,c)}function O(e,b,c){b in e?Object.defineProperty(e,b,{value:c,enumerable:!0,configurable:!0,writable:!0}):e[b]=c}
function P(e){var b=Array.isArray(e)?xa(e):void 0;b||(b="undefined"!==typeof Symbol&&Symbol.iterator in Object(e)?Array.from(e):void 0);if(!(e=b||va(e)))throw new TypeError("Invalid attempt to spread non-iterable instance.\nIn order to be iterable, non-array objects must have a [Symbol.iterator]() method.");return e}
function va(e,b){if(e){if("string"===typeof e)return xa(e,b);var c=Object.prototype.toString.call(e).slice(8,-1);"Object"===c&&e.constructor&&(c=e.constructor.name);if("Map"===c||"Set"===c)return Array.from(e);if("Arguments"===c||/^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(c))return xa(e,b)}}function xa(e,b){if(null==b||b>e.length)b=e.length;for(var c=0,d=Array(b);c<b;c++)d[c]=e[c];return d}var Q=Object.create(null);Q.browser=Object.create(null);Q.feature=Object.create(null);
...
e._assistant.object.getKeyByValue(e._enum.STATUS,b);else if(c=b.toUpperCase(),void 0===(b=e._enum.STATUS[c]))throw Error("Illegal value");this.status=b;this.variable.nodes.container.setAttribute("modal-layer-status",c.toLowerCase())}},{key:"resize",value:function(){var b;var c=[0,0];var d=this.variable.nodes.container;var f=d.children;c[0]=(null!==(b=e._assistant.number.multiply)&&void 0!==b?b:e._assistant.number.mul)(window.innerWidth,this.option.areaProportion[0]);d.style.width=c[0]+"px";for(b=
0;b<f.length;b++)c[1]="absolute"==getComputedStyle(f[b],null).position?c[1]:Math.max(e._assistant.element.getNodeHeight(f[b]),c[1]);d.style.height=c[1]+"px";this.variable.defaultArea=c}},{key:"resizeByXYWH",value:function(b,c,d,f){var g;var h=this.variable.nodes.container;null===this.option.window?g={x:0,y:0,top:0,left:0,right:window.innerWidth,width:window.innerWidth,bottom:window.innerHeight,height:window.innerHeight}:g=this.option.window.getBoundingClientRect();b<g.x&&(b=g.x);b+d>g.right&&(d=g.right-
b);c<g.y&&(c=g.y);c+f>g.bottom&&(f=g.bottom-c);h.style.marginLeft=b+"px";h.style.marginTop=c+"px";h.style.width=d+"px";h.style.height=f+"px";[e._enum.TYPE.PAGE,e._enum.TYPE.VIDEO,e._enum.TYPE.AUDIO].includes(this.type)&&(b=h.querySelector("iframe[name="+this.option.layer.name+this.option.index+"]"),b.style.width=this.option.layer.area[0]+d-this.variable.defaultArea[0]+"px",b.style.height=this.option.layer.area[1]+f-this.variable.defaultArea[1]+"px")}},{key:"show",value:function(){var b=this;var c=
this.variable.nodes;var d=e._assistant.element.maxZIndex();if(0===Object.keys(c).length||this.status===e._enum.STATUS.SHOW)return Promise.resolve();var f=this.variable.animationName.transition_opacity+" "+this.option.transition.time+"s ease forwards";var g=this.variable.animationName.transition_scale+" "+this.option.transition.time+"s ease forwards";Object.keys(c).forEach(function(k){c[k].style.zIndex=d+1});var h=new Promise(function(k){c.container.onanimationend=function(){0<b.option.popupTime&&
b.event.autoShutdown.call(b);c.container.onanimationend=null;k()}});c.mask&&(c.mask.style.animation=f);c.container.style.animation=f+", "+g;Object.keys(c).forEach(function(k){c[k].classList.contains("modal-layer-hide")&&c[k].classList.replace("modal-layer-hide","modal-layer-show")},this);this.setStatus("show");return h}},{key:"hide",value:function(){var b=this;var c=this.variable.nodes;if(0===Object.keys(c).length||this.status===e._enum.STATUS.HIDE)return Promise.resolve();Number.isInteger(this.variable.timeout.auto_shutdown)&&
window.clearTimeout(this.variable.timeout.auto_shutdown);var d=this.variable.animationName.transition_opacity+"-reverse "+this.option.transition.time+"s ease forwards";var f=this.variable.animationName.transition_scale+"-reverse "+this.option.transition.time+"s ease forwards";var g=new Promise(function(h){c.container.onanimationend=function(){Object.keys(c).forEach(function(k){c[k].classList.contains("modal-layer-show")&&c[k].classList.replace("modal-layer-show","modal-layer-hide")});b.setStatus("hide");
c.container.onanimationend=null;null!==b.option.parentModalLayer&&b.option.parentModalLayer.show();h()}});c.mask&&(c.mask.style.animation=d);c.container.style.animation=d+", "+f;return g}},{key:"minimize",value:function(){var b=this;if(this.status!==e._enum.STATUS.MINIMIZE){var c=document.querySelector("#modal-layer-minimize-queue");c||(c=e._assistant.element.objectToNode([e._struct.minimize_queue])[0],c.classList.add(this.option.ui,"modal-layer-skin-".concat(this.option.skin)),e._variable.minimizeQueueEvent=
e._assistant.event.add(c,"click",".modal-layer-minimize-queue-item",this.event.minimizeRevert,null,null,!1),document.body.insertAdjacentElement("beforeend",c));var d=this.variable.nodes.container.querySelector(".modal-layer-title-content").innerHTML;var f=e._assistant.element.objectToNode([e._struct.minimize_queue_item])[0];f.classList.add(this.option.ui);f.setAttribute("modal-layer-index",this.option.index);f.querySelector(".modal-layer-minimize-queue-item-title").innerHTML=d;c.insertAdjacentElement("beforeend",
f);var g=setInterval(function(){f.parentNode&&(f.style.animation="opacity 0.3s ease forwards, "+b.variable.animationName.minimize_queue_transition_scale+" 0.3s ease forwards",clearInterval(g))},10);this.hide().then(function(){return void b.setStatus("minimize")})}}},{key:"revert",value:function(){var b=this;var c=document.querySelector("#modal-layer-minimize-queue");var d=c.querySelector('.modal-layer-minimize-queue-item[modal-layer-index="'+this.option.index+'"]');if([e._enum.STATUS.MINIMIZE].includes(this.status)){d.onanimationstart=
function(){setTimeout(function(){b.show();d.onanimationstart=null},150)};var f=new Promise(function(g){d.onanimationend=function(){d.remove();0>=e._minimizeQueue.length&&(c.remove(),e._assistant.event.remove(e._variable.minimizeQueueEvent));g()}});d.style.animation="opacity-reverse 0.3s ease forwards, "+this.variable.animationName.minimize_queue_transition_scale+"-reverse 0.3s ease forwards";return f}}},{key:"remove",value:function(){var b=this;var c=this.variable.nodes;if(0===Object.keys(c).length||
[e._enum.STATUS.REMOVING,e._enum.STATUS.REMOVED].includes(this.status))return Promise.resolve();this.status===e._enum.STATUS.MINIMIZE&&delete e._minimizeQueue[e._minimizeQueue.indexOf(this)];this.setStatus("removing");return this.hide().then(function(){b.removeAllEvent();Object.keys(c).forEach(function(d){c[d].remove()});b.setStatus("removed")})}},{key:"delete",value:function(){var b=this;this.remove().then(function(){e.a.splice(b.option.index,1);e._assistant.object.dereference(b.event);e._assistant.object.dereference(b.option);
e._assistant.object.dereference(b.variable);b.event=b.option=b.variable=null})}},{key:"removeAllEvent",value:function(){var b;if(0!==Object.keys(b=this.variable.nodes).length){Object.values(this.variable.eventSymbol).forEach(function(g){return e._assistant.event.remove(g)});var c=b.container.querySelector(".modal-layer-interaction-btn-ok");var d=b.container.querySelector(".modal-layer-interaction-btn-no");var f=b.container.querySelector(".modal-layer-interaction-btn-cancel");b.container.removeEventListener("mousedown",
this.event.active);b.container.removeEventListener("click",this.event.action.close);b.container.removeEventListener("click",this.event.action.expand);b.container.removeEventListener("click",this.event.action.minimize);c&&c.removeEventListener("click",this.event.interaction_ok);d&&d.removeEventListener("click",this.event.interaction_no);f&&f.removeEventListener("click",this.event.interaction_cancel);document.removeEventListener("click",this.event.minimizeRevert)}}}],[{key:"removeAll",value:function(){for(var b=
0;b<e._instance.length;b++)e._instance[b].remove()}},{key:"msg",value:function(b,c){e.message(b,c)}},{key:"message",value:function(b,c){"string"===typeof b?b={content:b,type:e._enum.TYPE.MESSAGE}:b.type=e._enum.TYPE.MESSAGE;b=new (e._achieve.get("message"))(b,c);b.resize();b.show();return b}},{key:"alert",value:function(b,c){b.type=e._enum.TYPE.ALERT;b=new (e._achieve.get("alert"))(b,c);b.resize();b.show();return b}},{key:"confirm",value:function(b,c){b.type=e._enum.TYPE.CONFIRM;b=new (e._achieve.get("confirm"))(b,
c);b.resize();b.show();return b}},{key:"prompt",value:function(b,c){b.type=e._enum.TYPE.PROMPT;b=new (e._achieve.get("prompt"))(b,c);b.resize();b.show();return b}},{key:"page",value:function(b,c){b.type=e._enum.TYPE.PAGE;b=new (e._achieve.get("page"))(b,c);b.resize();b.show();return b}},{key:"image",value:function(b,c){var d=null;b.type=e._enum.TYPE.IMAGE;d=new (e._achieve.get("image"))(b,c);d.variable.image.finish.then(function(){return d.resize()}).then(function(){return d.show()});return d}},{key:"loading",
value:function(b,c){b.type=e._enum.TYPE.LOADING;b=new (e._achieve.get("loading"))(b,c);b.resize();b.show();return b}}]);return e}();O(S,"_env",Q);O(S,"_enum",V);O(S,"_struct",U);O(S,"_option",T);O(S,"_variable",new Map);O(S,"_worker",window.Worker?new Map:void 0);O(S,"_event",R);O(S,"_version",1);O(S,"_achieve",new Map);O(S,"_assistant",Object.create(null));
O(S,"_instance",new Proxy([],{set:function(e,b,c){if(c instanceof S||"length"===b)return e[b]=c,!0;throw new TypeError("Must be of type ModalLayer");}}));O(S,"_minimizeQueue",new Proxy([],{set:function(e,b,c){if(c instanceof S){var d=e.indexOf(c);c.minimize();0>d?e[b]=c:e[d]=c;return!0}return"length"===b?(e[b]=c,!0):!1},deleteProperty:function(e,b){b=parseInt(b);if(Number.isInteger(b)&&e[b]instanceof S){e[b].revert();if(e[b+1])for(;b<e.length-1;b++)e[b]=e[b+1];delete e[e.length-1];e.length--;return!0}}}));
Object.seal(S);Object.is(window.ModalLayer,S)?(console.group("ModalLayer already exists"),console.log("Already version ".concat(window.ModalLayer._version)),console.log("Try to introduce version: ".concat(S._version)),console.groupEnd()):(Object.preventExtensions(S),Object.defineProperty(window,"ModalLayer",{value:S}));
var ya=function(){function e(){I(this,e)}J(e,null,[{key:"createAnimation",value:function(b,c){var d="@keyframes "+b+" {";Object.keys(c).forEach(function(f){d+=f+"{"+c[f]+"}"});return d+"}"}},{key:"hasCss",value:function(b){return e.cssList.has(b)}},{key:"addCss",value:function(b,c){if(e.hasCss(b))return!1;e.styleNode||(e.styleNode=document.createElement("style"),document.head.appendChild(e.styleNode));c=c.trim();e.cssList.set(b,c);e.styleNode.innerHTML+=e.delimiter+c}},{key:"delCss",value:function(b){e.hasCss(b)&&
(b=new RegExp(e.delimiter+e.cssList.get(b),"g"),e.styleNode.innerHTML=e.styleNode.innerHTML.replace(b,""))}}]);return e}();O(ya,"cssList",new Map);O(ya,"delimiter","\n");O(ya,"styleNode",null);Object.defineProperty(S._assistant,"css",{value:ya});
var za=function(){function e(){I(this,e)}J(e,null,[{key:"getFileBinary",value:function(b,c){var d;c=null!==(d=c)&&void 0!==d?d:{};c=X.merge(c,{mode:"cors",method:"get",cache:"no-cache",redirect:"follow",credentials:"include",referrer:"no-referrer",headers:{"content-type":"text/plain"}});return fetch(b,c)}},{key:"getFileBlob",value:function(b){var c=null;b instanceof Blob?c=Promise.resolve(b):b instanceof Image||b instanceof Element&&"IMAGE"===b.nodeName?c=this.u(b.src).then(function(d){return d.blob()}):
...
void 0!==d?d:Object.create(null);d=[g];c=[[[Object.keys(b),Object.values(b)],[Object.keys(c),Object.values(c)]]];do{b=d.shift();f=c.shift();var h=ua(f);var k=ua(h[0]);f=k[0];k=k[1];var l=ua(h[1]);h=l[0];var m=l[1];h=P(new Set(h.concat(f)));for(var p=0;p<h.length;p++){var t=[h[p],m[p]];l=t[0];var q=t[1];t=k[f.indexOf(l)];var v=e.isEmpty(t);if((e.isEmpty(t)||e.isCollection(t))&&e.isCollection(q)){var w,r,x=[];b[l]=null!==(w=null===(r=v?q.constructor:t.constructor)||void 0===r?void 0:r())&&void 0!==
...
var Da=function(){function e(){I(this,e)}J(e,null,[{key:"mul",value:function(b,c){var d,f;b=[b.toString().split("."),c.toString().split(".")];c=Math.pow(10,Math.max(null!==(d=b[0][1].length)&&void 0!==d?d:0,null!==(f=b[1][1].length)&&void 0!==f?f:0));b=[[Number(b[0][0]),Number("0."+b[0][1])*c],[Number(b[1][0]),Number("0."+b[1][1])*c]];return(0!==b[0][0]?b[0][0]:1)*(0!==b[1][0]?b[1][0]:1)+b[0][1]*b[1][1]/c}},{key:"div",value:function(b,c){var d,f,g,h;var k=Math.pow(10,Math.max(null!==(d=null===(f=
...
var Z=function(){function e(){I(this,e)}J(e,null,[{key:"getStorage",value:function(b){var c=1<arguments.length&&void 0!==arguments[1]?arguments[1]:[];if(!e._achieve[b])throw Error("The specified storage ".concat(b," was not found."));return ta(e._achieve[b],P(c))}}]);return e}();O(Z,"_achieve",Object.create(null));Object.defineProperty(S._assistant,"storage",{value:Z});
var Ha=function(){function e(){I(this,e)}J(e,null,[{key:"drawText",value:function(b,c){c=X.o(c,{text:null,fill:!0,color:"black",direction:"ltr",textAlign:"center",textBaseline:"middle",font:"normal 16px Microsoft YaHei, serif",point:[b.canvas.width/2,b.canvas.height/2]});c.text&&(b.save(),b.font=c.font,b.fillStyle=c.color,b.direction=c.direction,b.textAlign=c.textAlign,b.textBaseline=c.textBaseline,c.point[1]+=b.measureText(c.text).G/2,!0===c.fill?b.fillText.apply(b,[c.text].concat(P(c.point),[c.maxWidth])):
...
var Ia=function(){function e(){I(this,e)}J(e,null,[{key:"getImagedata",value:function(b){if(b instanceof Image){var c=document.createElement("canvas");var d=c.getContext("2d");d.drawImage(b,0,0);b=d.getImageData(0,0,c.width,c.height)}else if(!(b instanceof ImageData))throw Error("can not parse image");return b}},{key:"grayscale",value:function(b){try{var c=e.getImagedata(b);var d=c.width*c.height*4;var f=new Uint8ClampedArray(c.data.length);for(b=0;b<d;b+=4){var g=c.data[b];var h=c.data[b+1];var k=
...
l[m]=g.data[p];l[m+1]=g.data[p+1];l[m+2]=g.data[p+2];l[m+3]=g.data[p+3];l[p]=g.data[m];l[p+1]=g.data[m+1];l[p+2]=g.data[m+2];l[p+3]=g.data[m+3]}}catch(t){throw t;}return new ImageData(l,h,k)}}]);return e}();O(Ia,"__gaussianMask",{});Object.defineProperty(S._assistant,"canvasFilter",{value:Ia});
var Ja=function(){function e(){I(this,e)}J(e,null,[{key:"loadFailedFade",value:function(b,c){var d,f,g,h;if(!(b instanceof CanvasRenderingContext2D))throw Error('Requires a value of type "CanvasRenderingContext2D"');X.isEmpty(c)&&(c=Object.create(null));var k="animation-loadFailedFade-"+Date.now()+"-"+performance.now()+(c.sign?"-"+c.sign:"");c=X.o(c,{duration:4,speed:null,icon:{size:72,"char":["!","?"],color:"rgba(220, 53, 69)",font:"bold 72px Microsoft YaHei, serif"},text:{size:16,color:"black",
...
var Ka=function(e){function b(){I(this,b);return c.apply(this,arguments)}G(b,e);var c=H(b);J(b,[{key:"initOption",value:function(d){E(F(b.prototype),"initOption",this).call(this,d);this.option.layer=S._assistant.object.merge(this.option.layer,S._option.page)}},{key:"linkageOption",value:function(){E(F(b.prototype),"linkageOption",this).call(this);null!==this.option.layer.src&&null!==this.option.layer.srcdoc&&(this.option.layer.srcdoc=null)}},{key:"initStruct",value:function(){E(F(b.prototype),"initStruct",
...
var La=function(e){function b(){I(this,b);return c.apply(this,arguments)}G(b,e);var c=H(b);J(b,[{key:"initStruct",value:function(){E(F(b.prototype),"initStruct",this).call(this);var d=this.variable.struct._build.container;var f=this.variable.struct._backup.title=S._struct.title;var g=this.variable.struct._backup.action=S._struct.action;var h=this.variable.struct._backup.content=S._struct.content;var k=this.variable.struct._backup.interaction=S._struct.interaction;var l=this.variable.struct._backup.action_button=
...
var Na=function(e){function b(){I(this,b);return c.apply(this,arguments)}G(b,e);var c=H(b);J(b,[{key:"initOption",value:function(d){var f=this,g;E(F(b.prototype),"initOption",this).call(this,d);this.option.layer=S._assistant.object.merge(this.option.layer,S._option.image);var h=[window.innerWidth,window.innerHeight];Object.values(this.option.layer.sizeRange).forEach(function(k){k.forEach(function(l,m){if((""+l).endsWith("%"))g=100;else if((""+l).endsWith("\u2030"))g=1E3;else if((""+l).includes("0."))g=
...
this.option.title,"image/png")}}]);return b}(S);S._achieve.set("image",Na);var Oa=function(e){function b(){I(this,b);return c.apply(this,arguments)}G(b,e);var c=H(b);J(b,[{key:"initStruct",value:function(){E(F(b.prototype),"initStruct",this).call(this);this.variable.struct._backup.interaction.innerHTML.push(this.variable.struct._backup.interaction_button.cancel)}}]);return b}(La);S._achieve.set("prompt",Oa);
var Pa=function(e){function b(){I(this,b);return c.apply(this,arguments)}G(b,e);var c=H(b);J(b,[{key:"initStruct",value:function(){E(F(b.prototype),"initStruct",this).call(this);this.variable.struct._backup.interaction.innerHTML.push(this.variable.struct._backup.interaction_button.no)}}]);return b}(La);S._achieve.set("confirm",Pa);
var Ma=function(e){function b(){I(this,b);return c.apply(this,arguments)}G(b,e);var c=H(b);J(b,[{key:"initOption",value:function(d){E(F(b.prototype),"initOption",this).call(this,d);this.option.layer=S._assistant.object.merge(this.option.layer,S._option.loading);this.option.title=!1;this.option.drag.enable=!1;this.option.resize.enable=!1;this.option.progress.enable=!1}},{key:"compatibleOption",value:function(d){var f={center:"center",right:"flex-end",left:"flex-start"};E(F(b.prototype),"compatibleOption",
...
"_type",null);O(this,"_record",null);O(this,"_storage",null)}J(e,[{key:"has",value:function(){}},{key:"get",value:function(){}},{key:"set",value:function(){}},{key:"del",value:function(){}},{key:"clear",value:function(){}}]);return e}());Z&&(Object.defineProperty(Z._achieve,S._enum.BROWSER_STORAGE.LOCALSTORAGE,{value:Ra}),Object.defineProperty(Z._achieve,S._enum.BROWSER_STORAGE.SESSIONSTORAGE,{value:Ra}));}(window);
